...
- (void) initCustomizedWithBuilder
{
  ...
  if (true){ //GeaCrone
    ...
    public:
      ...
      GeaCronSymbolizer(Color c):_color(c){}
      
      std::vector<GEOSymbol*>* createSymbols(const GEO2DPointGeometry* geometry) const{ return NULL;}
      
      std::vector<GEOSymbol*>* createSymbols(const GEO2DLineStringGeometry*      geometry) const{ return NULL;}
      std::vector<GEOSymbol*>* createSymbols(const GEO2DMultiLineStringGeometry* geometry) const{ return NULL;}
    ...
    
    {
      ...
      if (geoJSONFilePath) {
        ...
        if (nsGEOJSON) {
          ...
          geaCronRenderer1800->addGEOObject(geoObject);
    ...
    
    {
      ...
      if (geoJSONFilePath) {
        ...
        if (nsGEOJSON) {
          ...
          geaCronRenderer1900->addGEOObject(geoObject);
          
        }
      }
    }
    
    class GeaCronTask: public GTask{
      
      Renderer *_r1, *_r2;
    public:
      GeaCronTask(Renderer* r1, Renderer* r2):_r1(r1), _r2(r2){}
