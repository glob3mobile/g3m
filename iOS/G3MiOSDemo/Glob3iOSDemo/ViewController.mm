...
//  //  if (pitch == pitch){
//  //    printf("P: %f\n", pitch*180/PI);
//  //    [G3MWidget widget]->setCameraHeadingPitchRoll(Angle::fromRadians(0.0),
...
- (void) testBranch_zrender_touchhandlers
{
  ...
  Sector sector = Sector::fromDegrees(27.967811065876,  -17.0232177085356,
                                      28.6103464294992, -16.0019401695656);
...
//  Geodetic3D position = Geodetic3D(Angle::fromDegrees(27.60), Angle::fromDegrees(-16.54), 35000.0);
  Geodetic3D position = Geodetic3D(Angle::fromDegrees(27.90), Angle::fromDegrees(-16.52), 25000.0);
