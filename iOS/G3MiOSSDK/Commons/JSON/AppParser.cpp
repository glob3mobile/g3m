...
void AppParser::parseWorldConfiguration(LayerSet* layerSet, MarksRenderer* marks, JSONObject* jsonWorld){
  ...
  if (jsonBaseLayer == "BING"){
    WMSLayer* bing = new WMSLayer("ve",
                                  ...
                                  WMS_1_1_0,
                                  Sector::fromDegrees(jsonBbox->getElement(0)->getNumber()->getDoubleValue(), jsonBbox->getElement(1)->getNumber()->getDoubleValue(), jsonBbox->getElement(2)->getNumber()->getDoubleValue(), jsonBbox->getElement(3)->getNumber()->getDoubleValue()),
                                  "image/jpeg",
                                  "EPSG:4326",
                                  "",
                                  false,
