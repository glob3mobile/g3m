...
MutableMatrix44D GLU::translationMatrix(const Vector3D& t) {
...
MutableMatrix44D GLU::rotationMatrix(const Angle& angle,
                                     const Vector3D& p) {
...
MutableMatrix44D GLU::lookAtMatrix(const MutableVector3D& pos,
...
MutableMatrix44D GLU::projectionMatrix(double left, double right,
