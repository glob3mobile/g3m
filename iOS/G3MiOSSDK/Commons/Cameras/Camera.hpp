...
public:
    ...
    virtual const MutableMatrix44D& getModelMatrix() const = 0;
    
    virtual const MutableMatrix44D& getProjectionMatrix() const = 0;
    
    virtual const MutableMatrix44D& getModelViewMatrix() const = 0;
};
