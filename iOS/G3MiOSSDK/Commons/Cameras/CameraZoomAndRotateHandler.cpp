...
bool CameraZoomAndRotateHandler::initZoom(const Planet* planet)
{
  // compute intersection of view direction with the globe
...
/*
  ...
  // if gesture isn't zoom, return false
  if (gesture!=Zoom) return false;*/
}
