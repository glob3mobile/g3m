...
void CameraHandler::initialize(const InitializationContext* ic){
  _logger = ic->getLogger();
}


void CameraHandler::onResizeViewportEvent(int width, int height) {
  if (_camera != NULL) {
...
Gesture CameraHandler::getGesture(const TouchEvent& touchEvent) {
