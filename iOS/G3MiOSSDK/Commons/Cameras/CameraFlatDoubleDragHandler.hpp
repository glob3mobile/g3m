...
#ifndef __G3MiOSSDK__CameraFlatDoubleDragHandler__
#define __G3MiOSSDK__CameraFlatDoubleDragHandler__

#include "CameraEventHandler.hpp"
#include "Camera.hpp"


class CameraFlatDoubleDragHandler: public CameraEventHandler {
private:
  const bool _processRotation;
  const bool _processZoom;
  
public:
  CameraFlatDoubleDragHandler(bool processRotation,
                          bool processZoom):
  _camera0(Camera(0, 0)),
  _initialPoint(0,0,0),
  _initialPixel(0,0,0),
...
#endif /* defined(__G3MiOSSDK__CameraFlatDoubleDragHandler__) */
