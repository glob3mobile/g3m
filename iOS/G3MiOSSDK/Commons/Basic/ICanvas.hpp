...
protected:
  ...
  virtual void _circularClipping(float radius,
                                 float left, float top) = 0;
  
  virtual void _restoreCanvas() = 0;
  ...
  virtual IImage* _drawRoundImage(const IImage* image,
                                  float radius,
                                  float transparency) = 0;
  
  virtual IImage* _drawRoundedImage(const IImage* image,
                                    float radius,
                                    float transparency) = 0;
...
public:
  ...
  void circularClipping(float radius,
                        float left, float top);
  ...
  IImage* drawRoundImage(const IImage* image,
                         float radius,
                         float transparency);
  
  IImage* drawRoundedImage(const IImage* image,
                           float radius,
                           float transparency);
