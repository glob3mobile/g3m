...
{
public:
  int createTextureFromImages(GL2 * gl, const std::vector<const IImage*>& vImages, int width, int height) const;
  
  int createTextureFromImages(GL2 * gl, const IFactory* factory,
