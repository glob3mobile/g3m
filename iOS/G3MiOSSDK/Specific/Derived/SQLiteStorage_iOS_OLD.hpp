...
#ifndef G3MiOSSDK_SQLiteStorage_iOS_OLD_h
#define G3MiOSSDK_SQLiteStorage_iOS_OLD_h

#include "IStorage.hpp"

class SQLiteStorage_iOS_OLD: public IStorage
{
...
public:
  SQLiteStorage_iOS_OLD(const std::string databaseName,
  ...
  const ByteBuffer* read(const std::string& filename);
...
private:
  ...
  virtual const ByteBuffer* findFileFromFileName(const std::string& filename);
