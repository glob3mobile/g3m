//
//  G3MOLDPointCloud2DemoScene.cpp
//  G3MApp
//
...
class G3MOLDPointCloud2DemoScene_PointCloudMetadataListener : public OLDPointCloudsRenderer::PointCloudMetadataListener {
private:
  G3MWidget* _g3mWidget;
public:
  G3MOLDPointCloud2DemoScene_PointCloudMetadataListener(G3MWidget* g3mWidget) :
...
void G3MOLDPointCloud2DemoScene::rawActivate(const G3MContext *context) {
  ...
  model->getOLDPointCloudsRenderer()->addPointCloud(//URL("http://glob3mobile.dyndns.org:8080"),
                                                    ...
                                                    deltaHeight,
                                                    new G3MOLDPointCloud2DemoScene_PointCloudMetadataListener(g3mWidget),
                                                    true);
}
