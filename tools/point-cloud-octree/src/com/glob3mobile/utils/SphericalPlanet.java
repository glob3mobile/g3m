...
public class SphericalPlanet implements Planet {
   ...
   @Override
   public final GVector3D toCartesian(final Geodetic3D geodetic, final float verticalExaggeration) {
   ...
   private static final GVector3D geodeticSurfaceNormal(final Angle latitude, final Angle longitude) {
