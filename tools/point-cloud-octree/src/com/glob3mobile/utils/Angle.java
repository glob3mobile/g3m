...
public class Angle implements Serializable {
   ...
   public static Angle midAngle(final Angle angle1, final Angle angle2) {
   ...
   public final boolean isBetween(final Angle min, final Angle max) {
   ...
   public static Angle min(final Angle a1, final Angle a2) {
      return (a1._radians < a2._radians) ? a1 : a2;
   }

   public static Angle max(final Angle a1, final Angle a2) {
      return (a1._radians > a2._radians) ? a1 : a2;
   }
