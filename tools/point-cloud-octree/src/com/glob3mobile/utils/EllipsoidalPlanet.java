...
public class EllipsoidalPlanet implements Planet {
   ...
   private static GVector3D geodeticSurfaceNormal(final Angle latitude, final Angle longitude) {
   ...
   @Override
   public GVector3D toCartesian(final Angle latitude, final Angle longitude, final double height, final float verticalExaggeration) {
   ...
   @Override
   public GVector3D toCartesian(final Geodetic3D geodetic, final float verticalExaggeration) {
