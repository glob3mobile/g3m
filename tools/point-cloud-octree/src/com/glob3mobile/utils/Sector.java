...
public class Sector implements Serializable {
   ...
   public static Sector fromDegrees(final double minLatitudeInDegrees, final double minLongitudeInDegrees, final double maxLatitudeInDegrees,
   ...
   public static Sector fromRadians(final double minLatitudeInRadians, final double minLongitudeInRadians, final double maxLatitudeInRadians,
