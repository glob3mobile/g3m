...
public class KMeans {
   ...
   public static List<Geodetic3D> cluster(final List<Geodetic3D> positions,
      ...
      for (int i = 0; i < positionsSize; i++) {
         distances[i] = cartesianPoints.get(i).squaredDistance(center);
      }
      ...
      final IComparatorInt comparator = new IComparatorInt() {
         ...
         public int compare(final int index1,
            ...
            //            //            final double distance1 = cartesianPoints.get(index1).squaredDistance(center);
            //            //            final double distance2 = cartesianPoints.get(index2).squaredDistance(center);
