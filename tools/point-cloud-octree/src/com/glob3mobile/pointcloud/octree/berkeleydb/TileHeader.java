...
public class TileHeader {
   ...
   private static TileHeader deepestEnclosingTile(final TileHeader candidate, final Sector targetSector) {
   ...
   private static Sector createSectorForChild(final Sector sector, final byte index) {
