...
public interface PersistentLOD extends AutoCloseable {
   ...
   public static interface Visitor {
      ...
      boolean visit(PersistentLOD.Transaction transaction, PersistentLOD.Node node);
   ...
   void put(PersistentLOD.Transaction transaction, String id, List<List<Geodetic3D>> levelsPoints);
   ...
   void acceptDepthFirstVisitor(PersistentLOD.Transaction transaction, PersistentLOD.Visitor visitor);
   ...
   void acceptVisitor(PersistentLOD.Transaction transaction, PersistentLOD.Visitor visitor, Sector sector);

   PersistentLOD.Node getNode(String id, boolean loadPoints);

   PersistentLOD.NodeLevel getNodeLevel(String nodeID, int level, boolean loadPoints);
