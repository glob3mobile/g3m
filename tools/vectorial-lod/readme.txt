...
* LOD parameters:
- QUALITY_FACTOR: value used to adjust simplification tolerance for Douglas-Peucker simplification. Greater values entail less tolerance, and so on less vertex filtered and more vertex generate for the resultant geometry. Usual values between 1.0 to 10.0
