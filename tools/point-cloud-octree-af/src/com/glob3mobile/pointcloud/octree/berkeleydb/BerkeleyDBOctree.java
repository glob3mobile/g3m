...
public class BerkeleyDBOctree implements PersistentOctree {
	...
	private double _minLatitudeInRadians; // min enclosing sector on buffer
	...
	synchronized public void flush() {
		...
		if (bufferSize > 0) {
			...
			// search for deepest node of quad tree that contains all the points
			// in the buffer
			// target sector is he min enclosing sector - aabb
			// sector contains all the points in the buffer
