...
public class G3Mesh {
   ...
   //      _normals = hasNormals ? new ArrayList<>() : null;
   //      _colors = hasColors ? new ArrayList<>() : null;
   //      _texCoords = hasTexCoords ? new ArrayList<>() : null;
   //      _indices = hasIndices ? new ArrayList<>() : null;
   //   }
   ...
   //         addVertex(centerX, centerY, centerZ, topCorner0._longitude._degrees, topCorner0._latitude._degrees, topCorner0._height);
   //         addVertex(centerX, centerY, centerZ, topCorner0._longitude._degrees, topCorner0._latitude._degrees, lowerHeight);
   //         addVertex(centerX, centerY, centerZ, topCorner1._longitude._degrees, topCorner1._latitude._degrees, lowerHeight);
   //         addVertex(centerX, centerY, centerZ, topCorner1._longitude._degrees, topCorner1._latitude._degrees, topCorner1._height);
   //
