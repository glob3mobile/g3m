...
public class Logger_JavaDesktop
   ...
   public void logInfo(final String x,
      ...
      try {
         ...
         Logger.getLogger(getClass().getName()).log(Level.INFO, "Info: " + res, res);
      }
   ...
   public void logWarning(final String x,
      ...
      try {
         final String res = String.format(_locale, x, legacyParamArray);
         Logger.getLogger(getClass().getName()).log(Level.WARNING, "Warning: " + res, res);
      }
      catch (final IllegalFormatException e) {
         Logger.getLogger(getClass().getName()).log(Level.WARNING, "Warning: " + x + " " + Arrays.toString(legacyParamArray));
      }
   }
   ...
   public void logError(final String x,
      ...
      try {
         final String res = String.format(_locale, x, legacyParamArray);
         Logger.getLogger(getClass().getName()).log(Level.SEVERE, "Error: " + res, res);
      }
      catch (final IllegalFormatException e) {
         Logger.getLogger(getClass().getName()).log(Level.SEVERE, "Error: " + x + " " + Arrays.toString(legacyParamArray));
      }
