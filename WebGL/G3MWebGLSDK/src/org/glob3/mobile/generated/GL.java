...
public class GL {
   ...
   private int checkedGetAttribLocation(final IGLProgramId program,
                                        final String name) {
   ...
   private IGLUniformID checkedGetUniformLocation(final IGLProgramId program,
                                                  final String name) {
      final IGLUniformID uID = _gl.getUniformLocation(program, name);
      if (!uID.isValid()) {
   ...
   public final boolean useProgram(final IGLProgramId program) {
      // set shaders
   ...
   public final IGLTextureId uploadTexture(final IImage image,
                                           final int format,
   ...
   public final void bindTexture(final IGLTextureId textureId) {
   ...
   public final void drawBillBoard(final IGLTextureId textureId,
                                   final IFloatBuffer vertices,
   ...
   public final void deleteTexture(final IGLTextureId textureId) {
      if (textureId == null) {
         return;
      }
   ...
   public final void enableCullFace(final int face) {
      if (!_enableCullFace) {
