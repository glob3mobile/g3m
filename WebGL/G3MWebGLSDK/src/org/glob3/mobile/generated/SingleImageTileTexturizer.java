...
public class SingleImageTileTexturizer
         extends
            TileTexturizer {
   ...
   private IFloatBuffer createTextureCoordinates(final RenderContext rc,
                                                 final Mesh mesh) {
      final FloatBufferBuilderFromCartesian2D texCoors = new FloatBufferBuilderFromCartesian2D();
      ...
      for (int i = 0; i < mesh.getVertexCount(); i++) {
         ...
         if (_isMercatorImage) {
            ...
            final double limit = 85.5 * IMathUtils.instance().pi() / 180.0;
   ...
   public SingleImageTileTexturizer(final TilesRenderParameters parameters,
                                    final IImage image,
                                    final boolean isMercatorImage) {
      _texId = null;
      _image = image;
   ...
   public final Mesh texturize(final RenderContext rc,
      ...
      final TextureMapping texMap = new SimpleTextureMapping(_texId, createTextureCoordinates(rc, mesh), true);
