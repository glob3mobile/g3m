...
public final class FloatBuffer_WebGL extends IFloatBuffer {
   ...
   private native JavaScriptObject jsCreateBufferWith16Floats(final float f0, final float f1, final float f2, final float f3, final float f4, final float f5,
                                                              final float f6, final float f7, final float f8, final float f9, final float f10, final float f11,
                                                              final float f12, final float f13, final float f14, final float f15) /*-{
