...
public final class FloatBuffer_WebGL extends IFloatBuffer {
   ...
   private native void jsDeleteWebGLBuffer() /*-{
    this.@org.glob3.mobile.specific.FloatBuffer_WebGL::_gl.deleteBuffer(this.@org.glob3.mobile.specific.FloatBuffer_WebGL::_webGLBuffer);
   }-*/;
   ...
   private native JavaScriptObject jsCreateBufferWith16Floats(final float f0, final float f1, final float f2, final float f3, final float f4,
                                                              final float f5, final float f6, final float f7, final float f8, final float f9,
                                                              final float f10, final float f11, final float f12, final float f13, final float f14,
                                                              final float f15) /*-{
   ...
   @Override
   public native void put(final int i, final float value) /*-{
   ...
   @Override
   public native void rawPut(final int i, final float value) /*-{
    this.@org.glob3.mobile.specific.FloatBuffer_WebGL::_buffer[i] = value;
   }-*/;
   ...
   @Override
   public native void rawAdd(final int i, final float value) /*-{
    var buffer = this.@org.glob3.mobile.specific.FloatBuffer_WebGL::_buffer;
