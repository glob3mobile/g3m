...
public class TextUtils_WebGL extends ITextUtils {
   ...
   @Override
   public native void createLabelImage(final String label, final float fontSize, final Color color, final Color shadowColor,
                                       final IImageListener listener, final boolean autodelete) /*-{
