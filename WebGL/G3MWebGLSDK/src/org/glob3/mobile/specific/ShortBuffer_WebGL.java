...
public class ShortBuffer_WebGL extends IShortBuffer {
	...
	public ShortBuffer_WebGL(final short[] array, final int length) {
	...
	@Override
	public void put(final int i, final short value) {
		jsPut(i, value);
	}
	...
	private native JavaScriptObject jsCreateBufferWithData(
	...
	public String description() {
		return "ShortBuffer_WebGL(timestamp=" + _timestamp + ", buffer="
				+ _buffer + ")";
	}
