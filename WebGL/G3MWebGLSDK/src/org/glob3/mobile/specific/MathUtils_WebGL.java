...
public final class MathUtils_WebGL extends IMathUtils {
   ...
   @Override
   public double atan2(final double u, final double v) {
      return Math.atan2(u, v);
   }

   @Override
   public float atan2(final float u, final float v) {
   ...
   @Override
   public double pow(final double v, final double u) {
      return Math.pow(v, u);
   }

   @Override
   public float pow(final float v, final float u) {
   ...
   @Override
   public double min(final double d1, final double d2) {
      return (d1 < d2) ? d1 : d2;
   }

   @Override
   public double max(final double d1, final double d2) {
      return (d1 > d2) ? d1 : d2;
   }
   ...
   public long doubleToRawLongBits(final double value) {
      ...
      return (b1) | ((long) b2 << 8) | ((long) b3 << 16) | ((long) b4 << 24) | ((long) b5 << 32) | ((long) b6 << 40) | ((long) b7 << 48) | ((long) b8 << 56);
   }
   ...
   @Override
   public float max(final float f1, final float f2) {
      return Math.max(f1, f2);
   }

   @Override
   public int max(final int i1, final int i2) {
      return Math.max(i1, i2);
   }

   @Override
   public long max(final long l1, final long l2) {
   ...
   @Override
   public double mod(final double d1, final double d2) {
      return d1 % d2;
   }

   @Override
   public float mod(final float f1, final float f2) {
      return f1 % f2;
   }
   ...
   @Override
   public double copySign(final double a, final double b) {
