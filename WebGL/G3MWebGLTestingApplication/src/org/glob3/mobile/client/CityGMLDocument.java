...
import org.glob3.mobile.generated.CityGLMBuildingWall;
import org.glob3.mobile.generated.CityGMLBuildingSurface;
import org.glob3.mobile.generated.CityGMLBuildingSurfaceType;
...
XMLDocument {
   ...
   public ArrayList<org.glob3.mobile.generated.CityGMLBuilding> parseLOD2Buildings2() {
      ...
      for (final XMLDocument b : buildingsXML) {
         ...
         final ArrayList<org.glob3.mobile.generated.CityGMLBuildingSurface> surfaces = new ArrayList<CityGMLBuildingSurface>();
         ...
         for (final XMLDocument s : wallsXML) {
            final ArrayList<Double> coor = s.getTextContentAsNumberArray(" ");
            final CityGMLBuildingSurface w = CityGLMBuildingWall.createFromArrayOfCityGMLWGS84Coordinates(coor,
         ...
         final org.glob3.mobile.generated.CityGMLBuilding building = new org.glob3.mobile.generated.CityGMLBuilding(name,
                  roofType, surfaces);
