...
public class G3MWebGLTestingApplication
   ...
   private G3MWidget_WebGL createWidgetWithYouAreHere() {
      ...
      class YouAreHereTask
         ...
         public void run(final G3MContext context) {
            ...
            if (_mark == null) {
               ...
               _mark = new Mark(new URL("/g3m-marker.png"), Geodetic3D.fromDegrees(28.099999998178312, -15.41699999885168, 0),
                        AltitudeMode.ABSOLUTE, 4.5e+06, null, true, null, false);

               marksRenderer.addMark(_mark);
            }
            else {
               ILogger.instance().logInfo("User Position:%s", loc.getLocation().description());
      ...
      builder.addPeriodicalTask(new PeriodicalTask(TimeInterval.fromMilliseconds(1000), new YouAreHereTask()));
