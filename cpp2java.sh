...
#ls -laF ~/.wine/drive_c/users/${USER}/Application\ Data/Tangible\ Software\ Solutions\ Inc/C++\ to\ Java\ Converter/

#wine ../converter/converter.exe

#find iOS/G3MiOSSDK/Commons -iname "*.hpp" -or -iname "*.cpp"
