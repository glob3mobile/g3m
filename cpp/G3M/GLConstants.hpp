...
#ifndef G3M_GLConstants
#define G3M_GLConstants
...
public:
  ...
  static int mirroredRepeat() { return _mirroredRepeat; }
  ...
  static void init(const INativeGL* ngl) {
    ...
    _mirroredRepeat = ngl->TextureParameterValue_MirroredRepeat();
  }
};
