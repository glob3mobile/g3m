...
public class GEORenderer_GEOObjectBufferDownloadListener implements IBufferDownloadListener
{
  ...
  {
	ILogger.instance().logInfo("Downloaded GEOObject buffer from \"%s\" (%db)", url._path.c_str(), buffer.size());
