...
public class GPUProgram_OGL
         extends
            IGPUProgram {

   public static GPUProgram_OGL createProgram(final GL gl,
                                              final String name,
                                              final String vertexSource,
                                              final String fragmentSource) {

      final GPUProgram_OGL p = new GPUProgram_OGL();
   ...
   @Override
   public final void onUnused(final GL gl) {
   ...
   public final void applyChanges(final GL gl) {
      ...
      for (int i = 0; i < _nUniforms; i++) {
         final GPUUniform uniform = _createdUniforms[i];
      ...
      for (int i = 0; i < _nAttributes; i++) {
         final GPUAttribute attribute = _createdAttributes[i];
         if (attribute != null) {
   ...
   @Override
   protected final void getVariables(final GL gl) {
   ...
   @Override
   public void deleteShader(final GL gl,
                            final int shader) {
   ...
   @Override
   public void deleteProgram(final GL gl,
                             final IGPUProgram p) {
