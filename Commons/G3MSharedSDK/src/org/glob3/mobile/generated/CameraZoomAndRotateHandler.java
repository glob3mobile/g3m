...
//ORIGINAL LINE: Vector3D w = _centralGlobePoint.asVector3D().sub(_cameraPosition);
	Vector3D w = _centralGlobePoint.asVector3D().sub(new MutableVector3D(_cameraPosition));
...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: Vector2F difCurrentPixels = pixel1.sub(pixel0);
	Vector2F difCurrentPixels = pixel1.sub(new Vector2F(pixel0));
...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: Vector3D intersection = planet->closestIntersection(_cameraPosition.asVector3D(), _cameraCenter.sub(_cameraPosition).asVector3D());
		Vector3D intersection = planet.closestIntersection(_cameraPosition.asVector3D(), _cameraCenter.sub(new MutableVector3D(_cameraPosition)).asVector3D());
...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: _centralGlobeNormal.copyFrom(planet->geodeticSurfaceNormal(_centralGlobePoint));
		  _centralGlobeNormal.copyFrom(planet.geodeticSurfaceNormal(new MutableVector3D(_centralGlobePoint)));
	...
	switch (cameraContext.getCurrentGesture())
	{
	  case Zoom:
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: zoom(cameraContext->getNextCamera(), difCurrentPixels);
		zoom(cameraContext.getNextCamera(), new Vector2F(difCurrentPixels));
		break;
