...
public class ShapesRenderer_SceneJSBufferDownloadListener implements IBufferDownloadListener
{
  ...
  {
	ILogger.instance().logInfo("Downloaded SceneJS buffer from \"%s\" (%db)", url._path.c_str(), buffer.size());
