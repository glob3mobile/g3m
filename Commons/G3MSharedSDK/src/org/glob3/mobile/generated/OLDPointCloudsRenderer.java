...
public class OLDPointCloudsRenderer extends DefaultRenderer
{
...
//  class PointCloudLeafNode;
  ...
  private static class PointCloudInnerNode extends PointCloudNode
  {
    ...
    public final OLDPointCloudsRenderer.PointCloudInnerNode pruneUnneededParents()
    {
  ...
  private static class PointCloudMetadataParserAsyncTask extends GAsyncTask
  {
    ...
    private OLDPointCloudsRenderer.PointCloudLeafNode parseLeafNode(ByteBufferIterator it)
    {
  ...
  private static class PointCloud
  {
    ...
    public final void initialize(G3MContext context)
    {
      ...
      context.getDownloader().requestBuffer(metadataURL, _downloadPriority, _timeToCache, _readExpired, new OLDPointCloudsRenderer.PointCloudMetadataDownloadListener(this, context.getThreadUtils()), true);
    }
