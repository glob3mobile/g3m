...
public class Polygon3D {
   ...
   private final Polygon2D               _polygon2D;


   private Vector3D getNormalOfFirstVertex(final java.util.ArrayList<Vector3D> coor3D) {
   ...
   public Polygon3D(final java.util.ArrayList<Vector3D> coor3D) {
      _coor3D = coor3D;
      _normal = new Vector3D(getNormalOfFirstVertex(coor3D));
      final java.util.ArrayList<Vector2D> _coor2D = createCoordinates2D();
   ...
   public final java.util.ArrayList<Vector2D> createCoordinates2D() {
      ...
      final java.util.ArrayList<Vector2D> coor2D = new java.util.ArrayList<Vector2D>();
   ...
   public final short addTrianglesByEarClipping(final FloatBufferBuilderFromCartesian3D fbb,
      ...
      final Vector3D normal = getCCWNormal();
      for (int i = 0; i < _coor3D.size(); i++) {
