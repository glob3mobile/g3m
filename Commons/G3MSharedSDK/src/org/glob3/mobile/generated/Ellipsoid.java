...
public class Ellipsoid
{
  ...
  public final Vector3D _radii = new Vector3D();

  public final Vector3D _radiiSquared = new Vector3D();
  public final Vector3D _radiiToTheFourth = new Vector3D();
  public final Vector3D _oneOverRadiiSquared = new Vector3D();
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: Vector3D getRadiiSquared() const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: Vector3D getRadiiToTheFourth() const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: Vector3D getOneOverRadiiSquared() const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: double getMeanRadius() const
