...
public class PlanetTileTessellator
   ...
   public final Mesh createTileMesh(final Planet planet,
      ...
      final double minElevation = createSurface(tileSector, meshSector, meshResolution, elevationData, verticalExaggeration,
               mercator, vertices, indices, textCoords);
      ...
      return new IndexedGeometryMesh(GLPrimitive.triangleStrip(), vertices.getCenter(), vertices.create(), true,
               indices.create(), true, 1, 1);
   }
   ...
   public final Mesh createTileDebugMesh(final Planet planet,
      ...
      final Color color = Color.newFromRGBA((float) 1.0, (float) 0.0, 0, (float) 1.0);

      return new IndexedMesh(GLPrimitive.lineLoop(), true, vertices.getCenter(), vertices.create(), indices.create(), 1, 1,
               color, null, 0, false); // colorsIntensity -  colors
   }
   ...
   @Override
   public final Vector2D getTextCoord(final Tile tile,
