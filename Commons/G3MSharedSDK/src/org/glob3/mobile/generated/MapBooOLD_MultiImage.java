...
{
  private final Color _averageColor = new Color();
...
//ORIGINAL LINE: const Color getAverageColor() const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: java.util.ArrayList<MapBooOLD_MultiImage_Level*> getLevels() const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: MapBooOLD_MultiImage_Level* getBestLevel(int width) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: MapBooOLD_MultiImage* deepCopy() const
...
//ORIGINAL LINE: return new MapBooOLD_MultiImage(averageColor, levels);
	return new MapBooOLD_MultiImage(new Color(averageColor), levels);
  }
}
