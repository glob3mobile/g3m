package org.glob3.mobile.generated;public class BingMapsLayer extends RasterLayer
{
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: String getBrandLogoUri() const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: String getCopyright() const
...
//ORIGINAL LINE: const URL createURL(const Tile* tile) const
  ...
  {
	  this(imagerySet, key, timeToCache, readExpired, initialLevel, maxLevel, transparency, condition, new java.util.ArrayList<const Info*>());
  }
  ...
  {
	  this(imagerySet, key, timeToCache, readExpired, initialLevel, maxLevel, transparency, null, new java.util.ArrayList<const Info*>());
  }
  ...
  {
	  this(imagerySet, key, timeToCache, readExpired, initialLevel, maxLevel, 1, null, new java.util.ArrayList<const Info*>());
  }
  public BingMapsLayer(String imagerySet, String key, TimeInterval timeToCache, boolean readExpired, int initialLevel)
  {
	  this(imagerySet, key, timeToCache, readExpired, initialLevel, 25, 1, null, new java.util.ArrayList<const Info*>());
  }
  public BingMapsLayer(String imagerySet, String key, TimeInterval timeToCache, boolean readExpired)
  {
	  this(imagerySet, key, timeToCache, readExpired, 2, 25, 1, null, new java.util.ArrayList<const Info*>());
  }
  public BingMapsLayer(String imagerySet, String key, TimeInterval timeToCache)
  {
	  this(imagerySet, key, timeToCache, true, 2, 25, 1, null, new java.util.ArrayList<const Info*>());
  }
//C++ TO JAVA CONVERTER NOTE: Java does not allow default values for parameters. Overloaded methods are inserted above.
//ORIGINAL LINE: BingMapsLayer(const String& imagerySet, const String& key, const TimeInterval& timeToCache, const boolean readExpired = true, const int initialLevel = 2, const int maxLevel = 25, const float transparency = 1, const LayerCondition* condition = null, java.util.ArrayList<const Info*>* layerInfo = new java.util.ArrayList<const Info*>()) : RasterLayer(timeToCache, readExpired, null, transparency, condition, layerInfo), _imagerySet(imagerySet), _culture("en-US"), _key(key), _initialLevel(initialLevel), _maxLevel(maxLevel), _isInitialized(false)
  ...
  {
	  this(imagerySet, culture, key, timeToCache, readExpired, initialLevel, maxLevel, transparency, condition, new java.util.ArrayList<const Info*>());
  }
  ...
  {
	  this(imagerySet, culture, key, timeToCache, readExpired, initialLevel, maxLevel, transparency, null, new java.util.ArrayList<const Info*>());
  }
  ...
  {
	  this(imagerySet, culture, key, timeToCache, readExpired, initialLevel, maxLevel, 1, null, new java.util.ArrayList<const Info*>());
  }
  ...
  {
	  this(imagerySet, culture, key, timeToCache, readExpired, initialLevel, 25, 1, null, new java.util.ArrayList<const Info*>());
  }
  public BingMapsLayer(String imagerySet, String culture, String key, TimeInterval timeToCache, boolean readExpired)
  {
	  this(imagerySet, culture, key, timeToCache, readExpired, 2, 25, 1, null, new java.util.ArrayList<const Info*>());
  }
  public BingMapsLayer(String imagerySet, String culture, String key, TimeInterval timeToCache)
  {
	  this(imagerySet, culture, key, timeToCache, true, 2, 25, 1, null, new java.util.ArrayList<const Info*>());
  }
//C++ TO JAVA CONVERTER NOTE: Java does not allow default values for parameters. Overloaded methods are inserted above.
//ORIGINAL LINE: BingMapsLayer(const String& imagerySet, const String& culture, const String& key, const TimeInterval& timeToCache, const boolean readExpired = true, const int initialLevel = 2, const int maxLevel = 25, const float transparency = 1, const LayerCondition* condition = null, java.util.ArrayList<const Info*>* layerInfo = new java.util.ArrayList<const Info*>()) : RasterLayer(timeToCache, readExpired, null, transparency, condition, layerInfo), _imagerySet(imagerySet), _culture(culture), _key(key), _initialLevel(initialLevel), _maxLevel(maxLevel), _isInitialized(false)
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: BingMapsLayer* copy() const
  public final BingMapsLayer copy()
  {
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: return new BingMapsLayer(_imagerySet, _culture, _key, _timeToCache, _readExpired, _initialLevel, _maxLevel, _transparency, (_condition == null) ? null : _condition->copy(), _layerInfo);
	return new BingMapsLayer(_imagerySet, _culture, _key, new TimeInterval(_timeToCache), _readExpired, _initialLevel, _maxLevel, _transparency, (_condition == null) ? null : _condition.copy(), _layerInfo);
  }
...
//C++ TO JAVA CONVERTER TODO TASK: There is no direct equivalent to the STL vector 'insert' method in Java:
	  _errors.insert(_errors.end(), _metadataErrors.iterator(), _metadataErrors.end());
//#endif
//C++ TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
//#if JAVA_CODE
