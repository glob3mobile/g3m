...
public class CityGMLBuilding
{
  ...
  public final short addTrianglesCuttingEarsForAllWalls(FloatBufferBuilderFromCartesian3D fbb, FloatBufferBuilderFromCartesian3D normals, ShortBufferBuilder indexes, FloatBufferBuilderFromColor colors, double baseHeight, Planet planet, short firstIndex, Color color, boolean includeGround)
  {
  ...
  public final Mesh createIndexedMeshWithColorPerVertex(Planet planet, boolean fixOnGround, Color color, boolean includeGround)
  {
  ...
  public static Mesh createSingleIndexedMeshWithColorPerVertexForBuildings(java.util.ArrayList<CityGMLBuilding> buildings, Planet planet, boolean fixOnGround, boolean includeGround)
  {
    ...
    for (int i = 0; i < buildings.size(); i++)
    {
      ...
      firstIndex = b.addTrianglesCuttingEarsForAllWalls(fbb, normals, indexes, colors, baseHeight, planet, firstIndex, colorWheel.wheelStep((int)buildings.size(), buildingCounter), includeGround);
