package org.glob3.mobile.generated;public class G3MWidget extends ChangedRendererInfoListener
{
...
//ORIGINAL LINE: return new G3MWidget(gl, storage, downloader, threadUtils, cameraActivityListener, planet, cameraConstrainers, cameraRenderer, mainRenderer, busyRenderer, errorRenderer, hudRenderer, backgroundColor, logFPS, logDownloaderStatistics, initializationTask, autoDeleteInitializationTask, periodicalTasks, gpuProgramManager, sceneLighting, initialCameraPositionProvider, infoDisplay, viewMode);
		return new G3MWidget(gl, storage, downloader, threadUtils, cameraActivityListener, planet, cameraConstrainers, cameraRenderer, mainRenderer, busyRenderer, errorRenderer, hudRenderer, new Color(backgroundColor), logFPS, logDownloaderStatistics, initializationTask, autoDeleteInitializationTask, periodicalTasks, gpuProgramManager, sceneLighting, initialCameraPositionProvider, infoDisplay, viewMode);
	}
...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: _currentCamera->setGeodeticPosition(position);
			_currentCamera.setGeodeticPosition(new Geodetic3D(position));
			_currentCamera.setHeading(Angle.zero());
			_currentCamera.setPitch(Angle.fromDegrees(-90));
			_currentCamera.setRoll(Angle.zero());
    
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: _nextCamera->setGeodeticPosition(position);
			_nextCamera.setGeodeticPosition(new Geodetic3D(position));
...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: notifyTouchEvent(ec, touchEvent);
		notifyTouchEvent(new G3MEventContext(ec), touchEvent);
...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: notifyTouchEvent(ec, downUpEvent);
						notifyTouchEvent(new G3MEventContext(ec), downUpEvent);
						if (downUpEvent != null)
							downUpEvent.dispose();
					}
				}
	...
	public final void onResizeViewportEvent(int width, int height)
	{
		...
		{
			_multiPassRenderers.get(i).onResizeViewportEvent(ec, width, height);
		}
	}
	...
	public final void onPause()
	{
		...
		for (int i = 0; i < _multiPassRenderers.size(); ++i)
		{
			_multiPassRenderers.get(i).onPause(_context);
		}
	...
	public final void onResume()
	{
		...
		for (int i = 0; i < _multiPassRenderers.size(); ++i)
		{
			_multiPassRenderers.get(i).onResume(_context);
		}
	...
	public final void onDestroy()
	{
		...
		for (int i = 0; i < _multiPassRenderers.size(); ++i)
		{
			_multiPassRenderers.get(i).onDestroy(_context);
		}
...
//ORIGINAL LINE: WidgetUserData* getUserData() const
	...
	{
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: getNextCamera()->setGeodeticPosition(position);
		getNextCamera().setGeodeticPosition(new Geodetic3D(position));
		_initialCameraPositionHasBeenSet = true;
	}
	...
	{
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: getNextCamera()->setHeading(heading);
		getNextCamera().setHeading(new Angle(heading));
	}

	public final void setCameraPitch(Angle pitch)
	{
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: getNextCamera()->setPitch(pitch);
		getNextCamera().setPitch(new Angle(pitch));
	}

	public final void setCameraRoll(Angle roll)
	{
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: getNextCamera()->setRoll(roll);
		getNextCamera().setRoll(new Angle(roll));
	}

	public final void setCameraHeadingPitchRoll(Angle heading, Angle pitch, Angle roll)
	{
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: getNextCamera()->setHeadingPitchRoll(heading, pitch, roll);
		getNextCamera().setHeadingPitchRoll(new Angle(heading), new Angle(pitch), new Angle(roll));
	}
...
//ORIGINAL LINE: void setAnimatedCameraPosition(const Geodetic3D& position, const Angle& heading = Angle::zero(), const Angle& pitch = Angle::fromDegrees(-90))
	public final void setAnimatedCameraPosition(Geodetic3D position, Angle heading, Angle pitch)
	{
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: setAnimatedCameraPosition(TimeInterval::fromSeconds(3), position, heading, pitch);
		setAnimatedCameraPosition(TimeInterval.fromSeconds(3), new Geodetic3D(position), new Angle(heading), new Angle(pitch));
	}
...
//C++ TO JAVA CONVERTER NOTE: Java does not allow default values for parameters. Overloaded methods are inserted above.
//ORIGINAL LINE: void setAnimatedCameraPosition(const TimeInterval& interval, const Geodetic3D& position, const Angle& heading = Angle::zero(), const Angle& pitch = Angle::fromDegrees(-90), const boolean linearTiming = false, const boolean linearHeight = false)
...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: setAnimatedCameraPosition(interval, fromPosition, position, fromHeading, heading, fromPitch, pitch, linearTiming, linearHeight);
		setAnimatedCameraPosition(new TimeInterval(interval), new Geodetic3D(fromPosition), new Geodetic3D(position), new Angle(fromHeading), new Angle(heading), new Angle(fromPitch), new Angle(pitch), linearTiming, linearHeight);
	}
...
//C++ TO JAVA CONVERTER NOTE: Java does not allow default values for parameters. Overloaded methods are inserted above.
//ORIGINAL LINE: void setAnimatedCameraPosition(const TimeInterval& interval, const Geodetic3D& fromPosition, const Geodetic3D& toPosition, const Angle& fromHeading, const Angle& toHeading, const Angle& fromPitch, const Angle& toPitch, const boolean linearTiming = false, const boolean linearHeight = false)
...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: if (fromPosition.isEquals(toPosition) && fromHeading.isEquals(toHeading) && fromPitch.isEquals(toPitch))
		if (fromPosition.isEquals(new Geodetic3D(toPosition)) && fromHeading.isEquals(new Angle(toHeading)) && fromPitch.isEquals(new Angle(toPitch)))
		{
			return;
		}
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: Renderer* getHUDRenderer() const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: const G3MRenderContext* getG3MRenderContext() const
	public final G3MRenderContext getG3MRenderContext()
	{
	...
	{
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: const boolean changed = getPlanetRenderer()->setRenderedSector(sector);
		final boolean changed = getPlanetRenderer().setRenderedSector(new Sector(sector));
		if (changed)
		{
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: InfoDisplay* getInfoDisplay() const
	...
	public final void changedRendererInfo(int rendererIdentifier, java.util.ArrayList<const Info> info)
	{
		if(_infoDisplay != null)
		{
...
//ORIGINAL LINE: ViewMode getViewMode() const
	...
	public final void addNextPassRenderer(Renderer r)
	{
		r.initialize(_context);
		_multiPassRenderers.add(r);
	}


	public final void addFrameTask(FrameTask frameTask)
	{
	...
	private java.util.ArrayList<Renderer> _multiPassRenderers = new java.util.ArrayList<Renderer>();
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: void notifyTouchEvent(const G3MEventContext &ec, const TouchEvent* touchEvent) const
		...
		switch (renderStateType)
		{
			case RENDER_READY:
			{
				...
				if (!handled)
				{
					for (int i = 0; i < _multiPassRenderers.size(); ++i)
					{
						_multiPassRenderers.get(i).onTouchEvent(ec, touchEvent);
					}
				}
	...
	private RenderState calculateRendererState()
	{
		...
		for (int i = 0; i < _multiPassRenderers.size(); ++i)
		{
			Renderer mpr = _multiPassRenderers.get(i);
			RenderState s = mpr.getRenderState(_renderContext);
			if (s._type == RenderState_Type.RENDER_ERROR)
			{
				return s;
			}
			else if (s._type == RenderState_Type.RENDER_BUSY)
			{
				busyFlag = true;
			}
		}
...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: _leftEyeCam->setFOV(vFOV, hFOV_2);
				_leftEyeCam.setFOV(new Angle(vFOV), new Angle(hFOV_2));
...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: _rightEyeCam->setFOV(vFOV, hFOV_2);
				_rightEyeCam.setFOV(new Angle(vFOV), new Angle(hFOV_2));
			}
	...
	private void renderOrderedRenderable()
	{
