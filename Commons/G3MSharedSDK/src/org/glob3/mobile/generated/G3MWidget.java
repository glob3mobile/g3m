...
ChangedRendererInfoListener {
   ...
   public static G3MWidget create(final GL gl,
      ...
      return new G3MWidget(gl, storage, downloader, threadUtils, cameraActivityListener, planet, cameraConstrainers,
               ...
               sceneLighting, initialCameraPositionProvider, infoDisplay, viewMode);
   }
   ...
   public final void setViewMode(final ViewMode vm) {
      _viewMode = vm;
   ...
   private void rawRender(final RenderState_Type renderStateType) {
   ...
   private void rawRenderMono(final RenderState_Type renderStateType) {
   ...
   private void rawRenderStereoParallelAxis(final RenderState_Type renderStateType) {
      ...
      if (eyesUpdated) {
         ...
         final double eyesSeparation = 10;//(renderStateType == (RenderState_Type.RENDER_READY.getValue())) != 0 ? 200 : 0; // 0.03;
         ...
         final Vector3D leftEyePosition = camPos.add(eyesDirection.times(-eyesSeparation));
         final Vector3D leftEyeCenter = camCenter.add(eyesDirection.times(-eyesSeparation));
         _leftEyeCam.setLookAtParams(leftEyePosition.asMutableVector3D(), leftEyeCenter.asMutableVector3D(),
         ...
         final Vector3D rightEyePosition = camPos.add(eyesDirection.times(eyesSeparation));
         final Vector3D rightEyeCenter = camCenter.add(eyesDirection.times(eyesSeparation));

         _rightEyeCam.setLookAtParams(rightEyePosition.asMutableVector3D(), rightEyeCenter.asMutableVector3D(),
                  up.asMutableVector3D());
