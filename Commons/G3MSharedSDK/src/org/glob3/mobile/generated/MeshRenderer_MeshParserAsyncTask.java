...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: const Color interpolatedColor = interpolateColor(fromColor, middleColor, toColor, normalize((float) height, (float) minHeight, (float) maxHeight));
							final Color interpolatedColor = interpolateColor(new Color(fromColor), new Color(middleColor), new Color(toColor), normalize((float) height, (float) minHeight, (float) maxHeight));
