...
//ORIGINAL LINE: Matrix44D* createMultiplication(const Matrix44D &that) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: boolean isEquals(const Matrix44D& m) const
	...
	public static Matrix44D createScaleMatrix(double scaleX, double scaleY, double scaleZ)
	{
		return new Matrix44D(scaleX, 0, 0, 0, 0, scaleY, 0, 0, 0, 0, scaleZ, 0, 0, 0, 0, 1);
	}

//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: boolean isScaleMatrix() const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: boolean isTranslationMatrix() const
