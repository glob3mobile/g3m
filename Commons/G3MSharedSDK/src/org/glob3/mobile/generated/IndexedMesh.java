...
//ORIGINAL LINE: void rawRender(const G3MRenderContext* rc, const GLState& parentState) const
  ...
  public IndexedMesh(int primitive, boolean owner, Vector3D center, IFloatBuffer vertices, IIntBuffer indices, float lineWidth, float pointSize, Color flatColor, IFloatBuffer colors)
  {
	  this(primitive, owner, center, vertices, indices, lineWidth, pointSize, flatColor, colors, 0.0f);
  }
  public IndexedMesh(int primitive, boolean owner, Vector3D center, IFloatBuffer vertices, IIntBuffer indices, float lineWidth, float pointSize, Color flatColor)
  {
	  this(primitive, owner, center, vertices, indices, lineWidth, pointSize, flatColor, null, 0.0f);
  }
  public IndexedMesh(int primitive, boolean owner, Vector3D center, IFloatBuffer vertices, IIntBuffer indices, float lineWidth, float pointSize)
  {
...
//ORIGINAL LINE: IndexedMesh(const int primitive, boolean owner, const Vector3D& center, IFloatBuffer* vertices, IIntBuffer* indices, float lineWidth, float pointSize = 1, Color* flatColor = null, IFloatBuffer* colors = null, const float colorsIntensity = 0.0f) : AbstractMesh(primitive, owner, center, vertices, lineWidth, pointSize, flatColor, colors, colorsIntensity), _indices(indices)
  public IndexedMesh(int primitive, boolean owner, Vector3D center, IFloatBuffer vertices, IIntBuffer indices, float lineWidth, float pointSize, Color flatColor, IFloatBuffer colors, float colorsIntensity)
  {
