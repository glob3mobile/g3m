...
//ORIGINAL LINE: canvas->setFillColor(_backgroundColor);
	  ...
	  {
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: canvas->setLineColor(_borderColor);
		canvas.setLineColor(new Color(_borderColor));
...
//ORIGINAL LINE: ColumnLayoutImageBuilder(const java.util.ArrayList<IImageBuilder*>& children, int margin = 0, float borderWidth = 0.0f, const Color& borderColor = Color::transparent(), int padding = 0, const Color& backgroundColor = Color::transparent(), float cornerRadius = 0.0f, int childrenSeparation = 0) : LayoutImageBuilder(children, margin, borderWidth, borderColor, padding, backgroundColor, cornerRadius, childrenSeparation)
...
//C++ TO JAVA CONVERTER NOTE: Java does not allow default values for parameters. Overloaded methods are inserted above.
//ORIGINAL LINE: ColumnLayoutImageBuilder(IImageBuilder* child0, IImageBuilder* child1, int margin = 0, float borderWidth = 0.0f, const Color& borderColor = Color::transparent(), int padding = 0, const Color& backgroundColor = Color::transparent(), float cornerRadius = 0.0f, int childrenSeparation = 0) : LayoutImageBuilder(child0, child1, margin, borderWidth, borderColor, padding, backgroundColor, cornerRadius, childrenSeparation)
