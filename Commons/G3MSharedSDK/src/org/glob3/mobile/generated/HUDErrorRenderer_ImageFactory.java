...
public class HUDErrorRenderer_ImageFactory extends HUDImageRenderer.CanvasImageFactory
{
  ...
  protected final void drawOn(ICanvas canvas, int width, int height)
  {
    ...
    ICanvasUtils.drawStringsOn(_errors, canvas, width, height, VerticalAlignment.Middle, HorizontalAlignment.Center, Color.white(), 18, 5, Color.fromRGBA(0.9f, 0.4f, 0.4f, 1.0f), Color.transparent(), 16);
  }
