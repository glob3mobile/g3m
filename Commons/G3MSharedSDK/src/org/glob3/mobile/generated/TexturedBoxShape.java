...
public class TexturedBoxShape extends AbstractMeshShape
{
  ...
  private final Vector3F _textureRepetitions = new Vector3F();
...
//  Mesh* createSurfaceMesh(const G3MRenderContext* rc);
  ...
  private Mesh createSurfaceMeshWithNormals(G3MRenderContext rc)
  {
    ...
    float[] texCoords = { 0, 0, 0, _textureRepetitions._y, _textureRepetitions._x, 0, _textureRepetitions._x, 0, 0, _textureRepetitions._y, _textureRepetitions._x, _textureRepetitions._y, 0, 0, 0, _textureRepetitions._y, _textureRepetitions._x, 0, _textureRepetitions._x, 0, 0, _textureRepetitions._y, _textureRepetitions._x, _textureRepetitions._y, 0, 0, 0, _textureRepetitions._z, _textureRepetitions._x, 0, _textureRepetitions._x, 0, 0, _textureRepetitions._z, _textureRepetitions._x, _textureRepetitions._z, 0, 0, 0, _textureRepetitions._z, _textureRepetitions._x, 0, _textureRepetitions._x, 0, 0, _textureRepetitions._z, _textureRepetitions._x, _textureRepetitions._z, 0, 0, 0, _textureRepetitions._y, _textureRepetitions._x, 0, _textureRepetitions._x, 0, 0, _textureRepetitions._y, _textureRepetitions._x, _textureRepetitions._y, 0, 0, 0, _textureRepetitions._y, _textureRepetitions._x, 0, _textureRepetitions._x, 0, 0, _textureRepetitions._y, _textureRepetitions._x, _textureRepetitions._y};
      //FACE 1
      //FACE 2
      //FACE 3
      //FACE 4
    ...
    FloatBufferBuilderFromCartesian2D texC = new FloatBufferBuilderFromCartesian2D();
    for (int i = 0; i<numVertices; i++)
    {
    ...
    final TextureIDReference texID = rc.getTexturesHandler().getTextureIDReference(_image, GLFormat.rgba(), _imageName, true, GLTextureParameterValue.repeat());
  
    TextureMapping tm = new SimpleTextureMapping(texID, texC.create(), true, false);
    ...
    Mesh result = new DirectMesh(GLPrimitive.triangles(), true, vertices.getCenter(), vertices.create(), (_borderWidth>1)? _borderWidth : 1, 1, null, null, 1, true, normals.create());
    ...
    TexturedMesh texMesh = new TexturedMesh(result, true, tm, true, false);
  ...
  public TexturedBoxShape(Geodetic3D position, AltitudeMode altitudeMode, Vector3D extent, float borderWidth, IImage image, String imageName, Vector3F textureRepetitions)
  {
     this(position, altitudeMode, extent, borderWidth, image, imageName, textureRepetitions, null);
  }
  public TexturedBoxShape(Geodetic3D position, AltitudeMode altitudeMode, Vector3D extent, float borderWidth, IImage image, String imageName, Vector3F textureRepetitions, Color borderColor)
  {
