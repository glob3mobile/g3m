...
public class GL
{
  ...
  private IGPUProgram _currentGPUProgram;
  /////////////////////////////////////////////////
...
//C++ TO JAVA CONVERTER TODO TASK: The implementation of the following method could not be found:
//  IGLUniformID checkedGetUniformLocation(IGPUProgram program, String name);
//  const bool _verbose;
...
//  }
  ...
  public final boolean deleteProgram(IGPUProgram program)
  {
  ...
  public final void bindAttribLocation(IGPUProgram program, int loc, String name)
  {
    _nativeGL.bindAttribLocation(program, loc, name);
  }

  public final int getProgramiv(IGPUProgram program, int pname)
  {
    return _nativeGL.getProgramiv(program, pname);
  }

  public final GPUUniform getActiveUniform(IGPUProgram program, int i)
  {
    return _nativeGL.getActiveUniform(program, i);
  }

  public final GPUAttribute getActiveAttribute(IGPUProgram program, int i)
  {
  ...
  public final void useProgram(IGPUProgram program)
  {
    if (program != null)
    {
