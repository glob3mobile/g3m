...
//C++ TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
//#if JAVA_CODE
	public CompositeTileImageContribution _compositeContribution = new internal();
//#endif
...
//ORIGINAL LINE: const Sector visibleContributionSector = imageSector->intersection(_tileSector);
  ...
  private static class ComposerImageListener implements IImageListener
  {
...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: child->create(tile, childContribution->_contribution, resolution, tileDownloadPriority, logDownloadActivity, new ChildTileImageListener(composer, i), true, frameTasksExecutor);
	  child.create(tile, childContribution._contribution, new Vector2I(resolution), tileDownloadPriority, logDownloadActivity, new ChildTileImageListener(composer, i), true, frameTasksExecutor);
	}
  }
