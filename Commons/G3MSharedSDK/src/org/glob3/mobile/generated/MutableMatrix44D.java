...
//ORIGINAL LINE: Matrix44D* asMatrix44D() const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: boolean isEquals(const MutableMatrix44D& m) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: boolean isIdentity() const
  public final boolean isIdentity()
  {
	final MutableMatrix44D identity = MutableMatrix44D.identity();
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: return isEquals(identity);
	return isEquals(new MutableMatrix44D(identity));
  }
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: double get0() const
  public final double get0()
  {
	  return _m00;
  }
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: double get1() const
  public final double get1()
  {
	  return _m10;
  }
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: double get2() const
  public final double get2()
  {
	  return _m20;
  }
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: double get3() const
  public final double get3()
  {
	  return _m30;
  }
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: double get4() const
  public final double get4()
  {
	  return _m01;
  }
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: double get5() const
  public final double get5()
  {
	  return _m11;
  }
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: double get6() const
  public final double get6()
  {
	  return _m21;
  }
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: double get7() const
  public final double get7()
  {
	  return _m31;
  }
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: double get8() const
  public final double get8()
  {
	  return _m02;
  }
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: double get9() const
  public final double get9()
  {
	  return _m12;
  }
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: double get10() const
  public final double get10()
  {
	  return _m22;
  }
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: double get11() const
  public final double get11()
  {
	  return _m32;
  }
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: double get12() const
  public final double get12()
  {
	  return _m03;
  }
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: double get13() const
  public final double get13()
  {
	  return _m13;
  }
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: double get14() const
  public final double get14()
  {
	  return _m23;
  }
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: double get15() const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: Vector2F project(const Vector3F& point, const int vpLeft, const int vpTop, const int vpWidth, const int vpHeight) const
...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: const MutableMatrix44D R = MutableMatrix44D::createRotationMatrix(angle, axis);
	final MutableMatrix44D R = MutableMatrix44D.createRotationMatrix(new Angle(angle), new Vector3D(axis));
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: const MutableMatrix44D T2 = MutableMatrix44D::createTranslationMatrix(point);
	final MutableMatrix44D T2 = MutableMatrix44D.createTranslationMatrix(new Vector3D(point));
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: return T2.multiply(R).multiply(T1);
	return T2.multiply(new MutableMatrix44D(R)).multiply(new MutableMatrix44D(T1));
  }

  public static MutableMatrix44D createModelMatrix(MutableVector3D pos, MutableVector3D center, MutableVector3D up)
  {
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: const MutableVector3D w = center.sub(pos).normalized();
	final MutableVector3D w = center.sub(new MutableVector3D(pos)).normalized();
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: const double pe = w.dot(up);
	final double pe = w.dot(new MutableVector3D(up));
	final MutableVector3D v = up.sub(w.times(pe)).normalized();
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: const MutableVector3D u = w.cross(v);
	final MutableVector3D u = w.cross(new MutableVector3D(v));
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: return MutableMatrix44D(u.x(), v.x(), -w.x(), 0, u.y(), v.y(), -w.y(), 0, u.z(), v.z(), -w.z(), 0, -pos.dot(u), -pos.dot(v), pos.dot(w), 1);
	return new MutableMatrix44D(u.x(), v.x(), -w.x(), 0, u.y(), v.y(), -w.y(), 0, u.z(), v.z(), -w.z(), 0, -pos.dot(new MutableVector3D(u)), -pos.dot(new MutableVector3D(v)), pos.dot(new MutableVector3D(w)), 1);
...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: const MutableMatrix44D longitudeRotation = MutableMatrix44D::createRotationMatrix(longitude, Vector3D::upY());
	final MutableMatrix44D longitudeRotation = MutableMatrix44D.createRotationMatrix(new Angle(longitude), Vector3D.upY());
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: const MutableMatrix44D latitudeRotation = MutableMatrix44D::createRotationMatrix(latitude, Vector3D::downX());
	final MutableMatrix44D latitudeRotation = MutableMatrix44D.createRotationMatrix(new Angle(latitude), Vector3D.downX());
  
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: return changeReferenceCoordinatesSystem.multiply(longitudeRotation).multiply(latitudeRotation);
	return changeReferenceCoordinatesSystem.multiply(new MutableMatrix44D(longitudeRotation)).multiply(new MutableMatrix44D(latitudeRotation));
  }
