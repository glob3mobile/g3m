...
//C++ TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
//#if JAVA_CODE
  public GLState _parentGLState = new internal();
//#endif
...
//ORIGINAL LINE: void hasChangedStructure() const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: GLFeatureSet* getAccumulatedFeatures() const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: void setParent(const GLState* parent) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: void applyOnGPU(GL* gl, GPUProgramManager& progManager) const
  public final void applyOnGPU(GL gl, tangible.RefObject<GPUProgramManager> progManager)
  {
	...
	if (_valuesSet == null && _globalState == null)
	{
	  ...
	  tangible.RefObject<GPUVariableValueSet> tempRef__valuesSet = new tangible.RefObject<GPUVariableValueSet>(_valuesSet);
	  tangible.RefObject<GLGlobalState> tempRef__globalState = new tangible.RefObject<GLGlobalState>(_globalState);
	  GLFeatureGroup.applyToAllGroups(accumulatedFeatures, tempRef__valuesSet, tempRef__globalState);
	  _valuesSet = tempRef__valuesSet.argvalue;
	  _globalState = tempRef__globalState.argvalue;
  
	  final int uniformsCode = _valuesSet.getUniformsCode();
	  final int attributesCode = _valuesSet.getAttributesCode();
  
	  _linkedProgram = progManager.argvalue.getProgram(gl, uniformsCode, attributesCode); //GET RETAINED REFERENCE
	}
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: int getNumberOfGLFeatures() const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: GLFeature* getGLFeature(GLFeatureID id) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: GLFeatureSet* getGLFeatures(GLFeatureID id) const
