...
GPUProgramFactory {
   ...
   public BasicShadersGL2() {
      ...
      final GPUProgramSources sourcesBillboard = new GPUProgramSources("Billboard",
               emptyString + "attribute vec2 aTextureCoord;\n" + "uniform mat4 uModelview;\n"
      ...
      final GPUProgramSources sourcesBillboard_TransformedTexCoor = new GPUProgramSources("Billboard_TransformedTexCoor",
               emptyString + "attribute vec2 aTextureCoord;\n" + "uniform mat4 uModelview;\n"
                        + "uniform vec4 uBillboardPosition;\n"
                        + "uniform vec2 uBillboardAnchor; //Anchor in UV (texture-like) coordinates\n"
                        + "uniform vec2 uTextureExtent;\n" + "uniform vec2 uViewPortExtent;\n"
      ...
      final GPUProgramSources sourcesColorMesh = new GPUProgramSources("ColorMesh", emptyString + "attribute vec4 aPosition;\n"
      ...
      final GPUProgramSources sourcesColorMesh_DirectionLight = new GPUProgramSources("ColorMesh_DirectionLight",
               emptyString + "attribute vec4 aPosition;\n" + "attribute vec3 aNormal;\n" + "uniform mat4 uModelview;\n"
      ...
      final GPUProgramSources sourcesDefault = new GPUProgramSources("Default",
      ...
      final GPUProgramSources sourcesFlatColor2DMesh = new GPUProgramSources("FlatColor2DMesh",
               emptyString + "attribute vec2 aPosition2D;\n" + "uniform float uPointSize;\n" + "uniform vec2 uTranslation2D;\n"
      ...
      final GPUProgramSources sourcesFlatColorMesh = new GPUProgramSources("FlatColorMesh",
               emptyString + "attribute vec4 aPosition;\n" + "uniform mat4 uModelview;\n" + "uniform float uPointSize;\n"
                        + "void main() {\n" + "gl_Position = uModelview * aPosition;\n" + "gl_PointSize = uPointSize;\n" + "}\n",
               emptyString + "uniform lowp vec4 uFlatColor;\n" + "void main() {\n" + "gl_FragColor = uFlatColor;\n" + "}\n");
      this.add(sourcesFlatColorMesh);

      final GPUProgramSources sourcesFlatColorMesh_DirectionLight = new GPUProgramSources("FlatColorMesh_DirectionLight",
               emptyString + "attribute vec4 aPosition;\n" + "attribute vec3 aNormal;\n" + "uniform mat4 uModelview;\n"
                        + "uniform mat4 uModel;\n" + "uniform float uPointSize;\n" + "uniform vec3 uAmbientLightColor;\n"
                        + "uniform vec3 uDiffuseLightColor;\n" + "uniform vec3 uDiffuseLightDirection; //We must normalize\n"
                        + "varying vec3 lightColor;\n" + "void main() {\n"
      ...
      final GPUProgramSources sourcesFullTransformedTexCoorMultiTexturedMesh = new GPUProgramSources(
      ...
      final GPUProgramSources sourcesFullTransformedTexCoorTexturedMesh = new GPUProgramSources(
      ...
      final GPUProgramSources sourcesMultiTexturedMesh = new GPUProgramSources("MultiTexturedMesh",
               emptyString + "attribute vec4 aPosition;\n" + "attribute vec2 aTextureCoord;\n"
                        + "attribute vec2 aTextureCoord2;\n" + "uniform mat4 uModelview;\n" + "uniform float uPointSize;\n"
                        + "varying vec2 TextureCoordOut;\n" + "varying vec2 TextureCoordOut2;\n" + "void main() {\n"
                        + "gl_Position = uModelview * aPosition;\n" + "TextureCoordOut = aTextureCoord;\n"
      ...
      final GPUProgramSources sourcesNoColorMesh = new GPUProgramSources("NoColorMesh",
               emptyString + "attribute vec4 aPosition;\n" + "uniform mat4 uModelview;\n" + "uniform float uPointSize;\n"
                        + "void main() {\n" + "gl_Position = uModelview * aPosition;\n" + "gl_PointSize = uPointSize;\n" + "}\n",
               emptyString + "void main() {\n" + "gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); //RED\n" + "}\n");
      this.add(sourcesNoColorMesh);

      final GPUProgramSources sourcesShader = new GPUProgramSources(
               "Shader",
               emptyString
      ...
      final GPUProgramSources sourcesTextured2DMesh = new GPUProgramSources("Textured2DMesh",
               emptyString + "attribute vec2 aPosition2D;\n" + "attribute vec2 aTextureCoord;\n" + "uniform float uPointSize;\n"
                        + "varying vec2 TextureCoordOut;\n" + "uniform vec2 uTranslation2D;\n"
                        + "uniform vec2 uViewPortExtent;\n" + "void main() {\n" + "vec2 pixel = aPosition2D;\n"
                        + "pixel.x -= uViewPortExtent.x / 2.0;\n" + "pixel.y += uViewPortExtent.y / 2.0;\n"
      ...
      final GPUProgramSources sourcesTexturedMesh = new GPUProgramSources("TexturedMesh",
               emptyString + "attribute vec4 aPosition;\n" + "attribute vec2 aTextureCoord;\n" + "uniform mat4 uModelview;\n"
                        + "uniform float uPointSize;\n" + "varying vec2 TextureCoordOut;\n" + "void main() {\n"
                        + "gl_Position = uModelview * aPosition;\n" + "TextureCoordOut = aTextureCoord;\n"
                        + "gl_PointSize = uPointSize;\n" + "}\n", emptyString + "varying mediump vec2 TextureCoordOut;\n"
      ...
      final GPUProgramSources sourcesTexturedMesh_DirectionLight = new GPUProgramSources("TexturedMesh_DirectionLight",
               emptyString + "attribute vec4 aPosition;\n" + "attribute vec2 aTextureCoord;\n" + "attribute vec3 aNormal;\n"
                        + "uniform mat4 uModelview;\n" + "uniform mat4 uModel;\n" + "uniform float uPointSize;\n"
                        + "varying vec2 TextureCoordOut;\n"
      ...
      final GPUProgramSources sourcesTransformedTexCoorMultiTexturedMesh = new GPUProgramSources(
      ...
      final GPUProgramSources sourcesTransformedTexCoorTexturedMesh = new GPUProgramSources("TransformedTexCoorTexturedMesh",
               emptyString + "attribute vec4 aPosition;\n" + "attribute vec2 aTextureCoord;\n"
                        + "uniform mediump vec2 uTranslationTexCoord;\n" + "uniform mediump vec2 uScaleTexCoord;\n"
                        + "uniform mat4 uModelview;\n" + "uniform float uPointSize;\n" + "varying vec4 VertexColor;\n"
                        + "varying vec2 TextureCoordOut;\n" + "void main() {\n" + "gl_Position = uModelview * aPosition;\n"
      ...
      final GPUProgramSources sourcesTransformedTexCoorTexturedMesh_DirectionLight = new GPUProgramSources(
