...
//#if C_CODE
  ...
  private final URL _tubesURL = new URL();
//#endif
//C++ TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
//#if JAVA_CODE
  public final URL _serverURL = new internal();
  public final URL _tubesURL = new internal();
//#endif
...
//ORIGINAL LINE: Layer* parseLayer(const JSONBaseObject* jsonBaseObjectLayer) const
  private Layer parseLayer(JSONBaseObject jsonBaseObjectLayer)
  {
	...
	{
	  layer = new OSMLayer(defaultTimeToCache, true, 2, 1, null, new java.util.ArrayList<const Info*>()); //disclaimerInfo -  condition, -  transparency, -  initialLevel, -  readExpired,
	}
	else if (layerType.compareTo("MapQuest") == 0)
	{
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: layer = parseMapQuestLayer(jsonLayer, defaultTimeToCache);
	  layer = parseMapQuestLayer(jsonLayer, new TimeInterval(defaultTimeToCache));
	}
	else if (layerType.compareTo("BingMaps") == 0)
	{
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: layer = parseBingMapsLayer(jsonLayer, defaultTimeToCache);
	  layer = parseBingMapsLayer(jsonLayer, new TimeInterval(defaultTimeToCache));
	}
	else if (layerType.compareTo("CartoDB") == 0)
	{
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: layer = parseCartoDBLayer(jsonLayer, transparent, defaultTimeToCache);
	  layer = parseCartoDBLayer(jsonLayer, transparent, new TimeInterval(defaultTimeToCache));
	}
	else if (layerType.compareTo("MapBox") == 0)
	{
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: layer = parseMapBoxLayer(jsonLayer, defaultTimeToCache);
	  layer = parseMapBoxLayer(jsonLayer, new TimeInterval(defaultTimeToCache));
	}
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: MapQuestLayer* parseMapQuestLayer(const JSONObject* jsonLayer, const TimeInterval& timeToCache) const
  private MapQuestLayer parseMapQuestLayer(JSONObject jsonLayer, TimeInterval timeToCache)
  {
	...
	{
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: return MapQuestLayer::newOpenAerial(timeToCache);
	  return MapQuestLayer.newOpenAerial(new TimeInterval(timeToCache));
	}
  
	// defaults to OSM
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: return MapQuestLayer::newOSM(timeToCache);
	return MapQuestLayer.newOSM(new TimeInterval(timeToCache));
  }

//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: BingMapsLayer* parseBingMapsLayer(const JSONObject* jsonLayer, const TimeInterval& timeToCache) const
  private BingMapsLayer parseBingMapsLayer(JSONObject jsonLayer, TimeInterval timeToCache)
  {
	...
	return new BingMapsLayer(imagerySet, key, timeToCache, true, 2, 25, 1, null, new java.util.ArrayList<const Info*>()); // disclaimerInfo -  condition -  transparency -  maxLevel -  initialLevel -  readExpired
  }

//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: CartoDBLayer* parseCartoDBLayer(const JSONObject* jsonLayer, const boolean transparent, const TimeInterval& timeToCache) const
  private CartoDBLayer parseCartoDBLayer(JSONObject jsonLayer, boolean transparent, TimeInterval timeToCache)
  {
	...
	return new CartoDBLayer(userName, table, timeToCache, true, 1, transparent, null, new java.util.ArrayList<const Info*>()); // disclaimerInfo -  condition, -  isTransparent -  transparency -  readExpired
  }


//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: MapBoxLayer* parseMapBoxLayer(const JSONObject* jsonLayer, const TimeInterval& timeToCache) const
  private MapBoxLayer parseMapBoxLayer(JSONObject jsonLayer, TimeInterval timeToCache)
  {
	...
	return new MapBoxLayer(mapKey, timeToCache, true, 1, 19, 1, null, new java.util.ArrayList<const Info*>()); // disclaimerInfo -  condition -  transparency -  maxLevel -  initialLevel -  readExpired
  }

//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: WMSLayer* parseWMSLayer(const JSONObject* jsonLayer, const boolean transparent) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: URLTemplateLayer* parseURLTemplateLayer(const JSONObject* jsonLayer, const boolean transparent) const
  private URLTemplateLayer parseURLTemplateLayer(JSONObject jsonLayer, boolean transparent)
  {
	...
	{
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: result = URLTemplateLayer::newMercator(urlTemplate, sector, transparent, firstLevel, maxLevel, TimeInterval::fromDays(30));
	  result = URLTemplateLayer.newMercator(urlTemplate, new Sector(sector), transparent, firstLevel, maxLevel, TimeInterval.fromDays(30));
	}
	else
	{
...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: result = new URLTemplateLayer(urlTemplate, sector, transparent, TimeInterval::fromDays(30), true, new LevelTileCondition(firstLevel, maxLevel), LayerTilesRenderParameters::createDefaultWGS84(sector, 1, maxLevel));
	  result = new URLTemplateLayer(urlTemplate, sector, transparent, TimeInterval.fromDays(30), true, new LevelTileCondition(firstLevel, maxLevel), LayerTilesRenderParameters.createDefaultWGS84(new Sector(sector), 1, maxLevel));
	}
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: MapBooOLD_Scene* parseScene(const JSONObject* jsonObject) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: Color parseColor(const JSONString* jsonColor) const
  private Color parseColor(JSONString jsonColor)
  {
	...
	if (color == null)
	{
	  ILogger.instance().logError("Invalid format in attribute 'color' (%s)", jsonColor.value().c_str());
	  return Color.black();
	}
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: Sector* parseSector(const JSONBaseObject* jsonBaseObjectLayer) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: MapBooOLD_MultiImage* parseMultiImage(const JSONObject* jsonObject) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: MapBooOLD_MultiImage_Level* parseMultiImageLevel(const JSONObject* jsonObject) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: const MapBooOLD_CameraPosition* parseCameraPosition(const JSONObject* jsonObject) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: const String getApplicationCurrentSceneCommand() const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: const String getSendNotificationCommand(const Geodetic2D& position, const MapBooOLD_CameraPosition* cameraPosition, const String& message, const URL* iconURL) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: const String getSendNotificationCommand(const Geodetic2D& position, const Camera* camera, const String& message, const URL* iconURL) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: const String escapeString(const String& str) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: const String toCameraPositionJSON(const Camera* camera) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: const String toCameraPositionJSON(const MapBooOLD_CameraPosition* cameraPosition) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: MapBooOLD_Notification* parseNotification(const JSONObject* jsonObject) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: java.util.ArrayList<MapBooOLD_Notification*>* parseNotifications(const JSONArray* jsonArray) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: const URL* parseURL(const JSONString* jsonString) const
...
//C++ TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
//#if JAVA_CODE
	  _applicationListener.onScenesChanged(_context, new java.util.ArrayList<MapBooOLD_Scene>(_applicationScenes));
//#endif
	}
  }
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: const String getViewAsString() const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: const URL createApplicationCurrentSceneURL() const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: const URL createApplicationPollURL() const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: const Sector parseSector(const JSONObject* jsonObject, const String& paramName) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: int getApplicationEventId() const
  ...
  /** Private to MapbooBuilder, don't call it */
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: int getApplicationTimestamp() const
...
//#endif
  ...
  /** Private to MapbooBuilder, don't call it */
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: void saveApplicationData() const
  ...
  /** Private to MapbooBuilder, don't call it */
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: const URL createApplicationTubeURL() const
  ...
  public final void parseApplicationJSON(String json, URL url)
  {
	...
	{
	  ILogger.instance().logError("Can't parse ApplicationJSON from %s", url._path.c_str());
	}
	else
	{
	  final JSONObject jsonObject = jsonBaseObject.asObject();
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: parseApplicationJSON(jsonObject, url);
	  parseApplicationJSON(jsonObject, new URL(url));
	}
	if (jsonBaseObject != null)
  ...
  public final void parseApplicationJSON(JSONObject jsonObject, URL url)
  {
	...
	else
	{
	  ...
	  {
		errors.add(jsonError.value().c_str());
		ILogger.instance().logError("Server Error: %s", jsonError.value().c_str());
		if (_initialParse)
		{
		  _initialParse = false;
		  setHasParsedApplication();
...
//ORIGINAL LINE: parseApplicationJSON(jsonObject, url);
	  ...
	  {
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: parseApplicationJSON(json, url);
		parseApplicationJSON(json, new URL(url));
	  }
	}
	if (jsonBaseObject != null)
		jsonBaseObject.dispose();
  ...
  /** Private to MapbooBuilder, don't call it */
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: boolean isApplicationTubeOpen() const
  ...
  public final boolean onTerrainTouch(G3MEventContext ec, Vector2F pixel, Camera camera, Geodetic3D position, Tile tile)
  {
	...
	{
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: _applicationListener->onTerrainTouch(this, ec, pixel, camera, position, tile);
	  _applicationListener.onTerrainTouch(this, ec, new Vector2F(pixel), camera, new Geodetic3D(position), tile);
	}
  ...
  /** Private to MapbooBuilder, don't call it */
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: boolean hasParsedApplication() const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: const MapBooOLD_Notification* createNotification(const Geodetic2D& position, const Camera* camera, const String& message, const URL* iconURL) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: void sendNotification(const Geodetic2D& position, const MapBooOLD_CameraPosition* cameraPosition, const String& message, const URL* iconURL) const
  public final void sendNotification(Geodetic2D position, MapBooOLD_CameraPosition cameraPosition, String message, URL iconURL)
  {
	...
	{
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: _webSocket->send(getSendNotificationCommand(position, cameraPosition, message, iconURL));
	  _webSocket.send(getSendNotificationCommand(new Geodetic2D(position), cameraPosition, message, iconURL));
	}
	else
	{
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: void sendNotification(const Geodetic2D& position, const Camera* camera, const String& message, const URL* iconURL) const
  public final void sendNotification(Geodetic2D position, Camera camera, String message, URL iconURL)
  {
	if ((_webSocket != null) && _isApplicationTubeOpen)
	{
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: _webSocket->send(getSendNotificationCommand(position, camera, message, iconURL));
	  _webSocket.send(getSendNotificationCommand(new Geodetic2D(position), camera, message, iconURL));
	}
	else
	{
	  ILogger.instance().logError("Can't send notification, websocket disconnected");
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: const URL getServerURL() const
  ...
  {
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: _g3mWidget->getG3MContext()->getDownloader()->requestBuffer(createGetFeatureInfoRestURL(tile, size, pixel, position), DownloadPriority::HIGHER, TimeInterval::zero(), false, _featureInfoDownloadListener, false);
	_g3mWidget.getG3MContext().getDownloader().requestBuffer(createGetFeatureInfoRestURL(tile, new Vector2I(size), new Vector2I(pixel), new Geodetic3D(position)), DownloadPriority.HIGHER, TimeInterval.zero(), false, _featureInfoDownloadListener, false);
  }
