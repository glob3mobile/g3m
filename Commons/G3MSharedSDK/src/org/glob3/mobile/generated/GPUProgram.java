...
//ORIGINAL LINE: boolean compileShader(GL* gl, int shader, const String& source) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: boolean linkProgram(GL* gl) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: void deleteShader(GL* gl, int shader) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: int getProgramID() const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: int getGPUAttributesNumber() const
  public final int getGPUAttributesNumber()
  {
	  return _nAttributes;
  }
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: int getGPUUniformsNumber() const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: GPUUniform* getGPUUniform(const String& name) const
  public final GPUUniform getGPUUniform(String name)
  {
//C++ TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
//#if C_CODE
	final int key = (int)GPUVariable.getUniformKey(name);
//#endif
//C++ TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
//#if JAVA_CODE
	final int key = (int)GPUVariable.getUniformKey(name).getValue();
//#endif
	return _uniforms[key];
  }
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: GPUAttribute* getGPUAttribute(const String& name) const
...
//C++ TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
//#if JAVA_CODE
	final int key = (int)GPUVariable.getAttributeKey(name).getValue();
//#endif
	return _attributes[key];
  }

//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: GPUUniformBool* getGPUUniformBool(const String& name) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: GPUUniformVec2Float* getGPUUniformVec2Float(const String& name) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: GPUUniformVec4Float* getGPUUniformVec4Float(const String& name) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: GPUUniformFloat* getGPUUniformFloat(const String& name) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: GPUUniformMatrix4Float* getGPUUniformMatrix4Float(const String& name) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: GPUAttribute* getGPUAttributeVecXFloat(const String& name, int x) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: GPUAttributeVec1Float* getGPUAttributeVec1Float(const String& name) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: GPUAttributeVec2Float* getGPUAttributeVec2Float(const String& name) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: GPUAttributeVec3Float* getGPUAttributeVec3Float(const String& name) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: GPUAttributeVec4Float* getGPUAttributeVec4Float(const String& name) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: GPUUniform* getUniformOfType(const String& name, int type) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: GPUUniform* getGPUUniform(int key) const
  public final GPUUniform getGPUUniform(int key)
  {
	return _uniforms[key];
  }
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: GPUAttribute* getGPUAttribute(int key) const
  public final GPUAttribute getGPUAttribute(int key)
  {
	return _attributes[key];
  }
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: GPUAttribute* getGPUAttributeVecXFloat(int key, int x) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: int getNReferences() const
