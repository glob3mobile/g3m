...
//ORIGINAL LINE: double getElevationBoxAt(const ElevationData* elevationData, double x0, double y0, double x1, double y1) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: const Vector2D getParentXYAt(const ElevationData* elevationData, const Geodetic2D& position) const
...
//ORIGINAL LINE: const Vector2D parentDeltaXY = parentXYAtUpper.sub(parentXYAtLower);
	final Vector2D parentDeltaXY = parentXYAtUpper.sub(new Vector2D(parentXYAtLower));
