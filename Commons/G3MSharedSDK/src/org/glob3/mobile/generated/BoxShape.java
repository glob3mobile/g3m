...
//C++ TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
//#if JAVA_CODE
  public final Quadric _frontQuadric = new internal();
  public final Quadric _backQuadric = new internal();
  public final Quadric _leftQuadric = new internal();
  public final Quadric _rightQuadric = new internal();
  public final Quadric _topQuadric = new internal();
  public final Quadric _bottomQuadric = new internal();
//#endif
...
//ORIGINAL LINE: BoxShape(Geodetic3D* position, AltitudeMode altitudeMode, const Vector3D& extent, float borderWidth, const Color& surfaceColor, Color* borderColor = null, boolean useNormals = true) : AbstractMeshShape(position, altitudeMode), _extentX(extent._x), _extentY(extent._y), _extentZ(extent._z), _frontQuadric(Quadric::fromPlane(1, 0, 0, -extent._x/2)), _backQuadric(Quadric::fromPlane(-1, 0, 0, -extent._x/2)), _leftQuadric(Quadric::fromPlane(0, -1, 0, -extent._y/2)), _rightQuadric(Quadric::fromPlane(0, 1, 0, -extent._y/2)), _topQuadric(Quadric::fromPlane(0, 0, 1, -extent._z/2)), _bottomQuadric(Quadric::fromPlane(0, 0, -1, -extent._z/2)), _borderWidth(borderWidth), _surfaceColor(new Color(surfaceColor)), _borderColor(borderColor), _useNormals(useNormals)
  public BoxShape(Geodetic3D position, AltitudeMode altitudeMode, Vector3D extent, float borderWidth, Color surfaceColor, Color borderColor, boolean useNormals)
  {
	  ...
	  _extentY = extent._y;
	  _extentZ = extent._z;
	  _frontQuadric = new Quadric(Quadric.fromPlane(1, 0, 0, -extent._x/2));
	  _backQuadric = new Quadric(Quadric.fromPlane(-1, 0, 0, -extent._x/2));
	  _leftQuadric = new Quadric(Quadric.fromPlane(0, -1, 0, -extent._y/2));
	  _rightQuadric = new Quadric(Quadric.fromPlane(0, 1, 0, -extent._y/2));
	  _topQuadric = new Quadric(Quadric.fromPlane(0, 0, 1, -extent._z/2));
	  _bottomQuadric = new Quadric(Quadric.fromPlane(0, 0, -1, -extent._z/2));
...
//ORIGINAL LINE: java.util.ArrayList<double> frontDistance = transformedFront.intersectionsDistances(origin, direction);
	java.util.ArrayList<Double> frontDistance = transformedFront.intersectionsDistances(new Vector3D(origin), new Vector3D(direction));
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: java.util.ArrayList<double> backDistance = transformedBack.intersectionsDistances(origin, direction);
	java.util.ArrayList<Double> backDistance = transformedBack.intersectionsDistances(new Vector3D(origin), new Vector3D(direction));
...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: java.util.ArrayList<double> leftDistance = transformedLeft.intersectionsDistances(origin, direction);
	java.util.ArrayList<Double> leftDistance = transformedLeft.intersectionsDistances(new Vector3D(origin), new Vector3D(direction));
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: java.util.ArrayList<double> rightDistance = transformedRight.intersectionsDistances(origin, direction);
	java.util.ArrayList<Double> rightDistance = transformedRight.intersectionsDistances(new Vector3D(origin), new Vector3D(direction));
...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: java.util.ArrayList<double> topDistance = transformedTop.intersectionsDistances(origin, direction);
	java.util.ArrayList<Double> topDistance = transformedTop.intersectionsDistances(new Vector3D(origin), new Vector3D(direction));
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: java.util.ArrayList<double> bottomDistance = transformedBottom.intersectionsDistances(origin, direction);
	java.util.ArrayList<Double> bottomDistance = transformedBottom.intersectionsDistances(new Vector3D(origin), new Vector3D(direction));
