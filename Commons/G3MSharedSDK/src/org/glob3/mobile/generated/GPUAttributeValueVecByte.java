...
public class GPUAttributeValueVecByte extends GPUAttributeValue
{
  ...
  public GPUAttributeValueVecByte(IByteBuffer buffer, int attributeSize, int arrayElementSize, int index, int stride, boolean normalized)
  {
