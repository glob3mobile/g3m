...
//    MBShape(MBShape that);
  ...
  public static class MBVectorSymbology extends MBSymbology
  {
    ...
    {
      return new LabelImageBuilder(label, GFont.sansSerif(18, true), new Vector2F(2, 2), Color.WHITE, Color.BLACK, 2.0f, 0.0f, 0.0f); // shadowOffsetY -  shadowOffsetX -  shadowBlur -  shadowColor -  color -  margin
    }
