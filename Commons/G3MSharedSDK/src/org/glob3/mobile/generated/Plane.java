...
//C++ TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
//#if JAVA_CODE
  public final Vector3F _normalF = new internal();
//#endif
...
//ORIGINAL LINE: const Vector3D normal = point1.sub(point0).cross(point2.sub(point0)).normalized();
	final Vector3D normal = point1.sub(new Vector3D(point0)).cross(point2.sub(new Vector3D(point0))).normalized();
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: const double d = -normal.dot(point0);
	final double d = -normal.dot(new Vector3D(point0));
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: return Plane(normal, d);
	return new Plane(new Vector3D(normal), d);
  }
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: float signedDistance(const Vector3F& point) const
...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: const Vector3D P2 = origin.add(direction);
	final Vector3D P2 = origin.add(new Vector3D(direction));
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: boolean isVectorParallel(const Vector3D& vector) const
  public final boolean isVectorParallel(Vector3D vector)
  {
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: const double d = _normal.dot(vector);
	final double d = _normal.dot(new Vector3D(vector));
	return ((d != d) || IMathUtils.instance().abs(d) < 0.01);
  }

//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: Angle vectorRotationForAxis(const Vector3D& vector, const Vector3D& axis) const
...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: if (isVectorParallel(vector))
	if (isVectorParallel(new Vector3D(vector)))
	{
	  return Angle.zero();
	}
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: Vector3D getNormal() const
