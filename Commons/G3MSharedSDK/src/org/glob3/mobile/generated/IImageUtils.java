...
public class IImageUtils
{
  ...
  public static void combine(int width, int height, java.util.ArrayList<const IImage> images, java.util.ArrayList<RectangleF> sourceRects, java.util.ArrayList<RectangleF> destRects, java.util.ArrayList<Float> transparencies, IImageListener listener, boolean autodelete)
  {
  ...
  public static void combine(Vector2I extent, java.util.ArrayList<const IImage> images, java.util.ArrayList<RectangleF> sourceRects, java.util.ArrayList<RectangleF> destRects, java.util.ArrayList<Float> transparencies, IImageListener listener, boolean autodelete)
  {
