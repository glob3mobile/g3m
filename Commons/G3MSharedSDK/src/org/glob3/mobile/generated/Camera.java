...
public class Camera {
   ...
   public final Vector2I point2Pixel(final Vector3F point) {
   ...
   public final void setCartesianPosition(final Vector3D v) {
   ...
   public final void setHeading(final Angle angle) {
      final Vector3D normal = _planet.geodeticSurfaceNormal(_position);
   ...
   public final void setPitch(final Angle angle) {
   ...
   public final void setGeodeticPosition(final Geodetic3D g3d) {
      _setGeodeticPosition(_planet.toCartesian(g3d));
   }


   public final void setGeodeticPosition(final Angle latitude,
   ...
   public final void setGeodeticPosition(final Geodetic2D g2d,
                                         final double height) {
    ...
    * 
    * The situation is like in the figure of this url: http: //en.wikipedia.org/wiki/Azimuth
    * 
    * At the end, camera will be in the 'Star' point, looking at the 'Observer' point.
    */
   public final void setPointOfView(final Geodetic3D center,
   ...
   private Angle getHeading(final Vector3D normal) {
      final Vector3D north2D = Vector3D.upZ().projectionInPlane(normal);
   ...
   private final CameraEffectTarget _camEffectTarget;
   ...
   private FrustumData calculateFrustumData() {
      ...
      final int __Testing_new_zNear_zFar_politic;
   ...
   private void _setGeodeticPosition(final Vector3D pos) {
