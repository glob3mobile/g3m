...
public class MapBoxLayer extends MercatorTiledLayer
{
  ...
  {
     this(mapKey, timeToCache, null);
  }
  public MapBoxLayer(String mapKey, TimeInterval timeToCache, LayerCondition condition) //initialMapBoxLevel,
              //int initialMapBoxLevel = 1,
  {
     super("MapBoxLayer", "http://", "tiles.mapbox.com/v3/" + mapKey, getSubdomains(), "png", timeToCache, Sector.fullSphere(), 1, 17, condition);
