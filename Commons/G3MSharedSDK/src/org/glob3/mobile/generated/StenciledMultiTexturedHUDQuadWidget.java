...
public class StenciledMultiTexturedHUDQuadWidget extends HUDWidget
{
...
//  const float _y;
  ...
  private boolean _downloadingImages;
  private IImage _image2;
  private IImage _stencilImage;
  private java.util.ArrayList<String> _errors = new java.util.ArrayList<String>();

  private Mesh _mesh;
  private StenciledMultiTextureMapping _mtMapping;
  ...
  private Mesh createMesh(G3MRenderContext rc)
  {
    ...
    final TextureIDReference stencilTexId = rc.getTexturesHandler().getTextureIDReference(_stencilImage, GLFormat.rgba(), _imageURL2.getPath(), false);
  ...
  //                                       true);
    ...
    _mtMapping = new StenciledMultiTextureMapping(texId, texCoords.create(), true, true, texId2, texCoords.create(), true, true, stencilTexId, texCoords.create(), true);
...
//#warning TO DIEGO : ONLY = NULL ???->check in all widgets
  ...
  public StenciledMultiTexturedHUDQuadWidget(URL imageURL, URL imageURL2, URL stencilURL, HUDPosition x, HUDPosition y, float width, float height)
  {
     _imageURL = imageURL;
  ...
  public final void initialize(G3MContext context)
  {
    if (!_downloadingImages && (_image == null) && (_image2 == null) && (_stencilImage == null))
    {
      ...
      downloader.requestImage(_imageURL, 1000000, TimeInterval.fromDays(30), true, new StenciledMultiTexturedHUDQuadWidget_ImageDownloadListener(this), true); // readExpired -  priority
  
      downloader.requestImage(_imageURL2, 1000000, TimeInterval.fromDays(30), true, new StenciledMultiTexturedHUDQuadWidget_ImageDownloadListener(this), true); // readExpired -  priority
  
      downloader.requestImage(_stencilURL, 1000000, TimeInterval.fromDays(30), true, new StenciledMultiTexturedHUDQuadWidget_ImageDownloadListener(this), true); // readExpired -  priority
    }
  }
...
//  void onImageDownload(IImage image, URL url);
  ...
  {
    _errors.add("StenciledMultiTexturedHUDQuadWidget: Error downloading \"" + url.getPath() + "\"");
  }
