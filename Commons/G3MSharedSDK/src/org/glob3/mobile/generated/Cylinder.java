...
//    Mesh createMesh(Color color, int nSegments, Planet planet);
    ...
    public static String adaptMeshes(MeshRenderer mr, java.util.ArrayList<CylinderMeshInfo> cylInfo, Camera camera, Planet planet)
    {
        ...
        java.util.ArrayList<Mesh> theMeshes = visibleMeshes(mr, camera, planet, cylInfo, visibleInfo);
    ...
    private final Vector3D _start ;
    private final Vector3D _end ;
    private final double _radius;
    private final double _startAngle;
    private final double _endAngle;

    private static java.util.ArrayList<Mesh > visibleMeshes(MeshRenderer mr, Camera camera, Planet planet, java.util.ArrayList<CylinderMeshInfo> cylInfo, java.util.ArrayList<CylinderMeshInfo> visibleInfo)
    {
    ...
    private void createSphere(java.util.ArrayList<Vector3D> vs)
    {
    ...
    private static double getAlpha(double distance, double proximityThreshold, boolean divide)
    {
        ...
        return java.lang.Double.NaN; // NAN
    }
