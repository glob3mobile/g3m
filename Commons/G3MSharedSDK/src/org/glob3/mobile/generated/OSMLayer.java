...
public class OSMLayer extends MercatorTiledLayer
{
  ...
  {
     this(timeToCache, readExpired, initialLevel, transparency, condition, java.util.<String>ArrayList());
  }
  public OSMLayer(TimeInterval timeToCache, boolean readExpired, int initialLevel, float transparency)
  {
     this(timeToCache, readExpired, initialLevel, transparency, null, java.util.<String>ArrayList());
  }
  public OSMLayer(TimeInterval timeToCache, boolean readExpired, int initialLevel)
  {
     this(timeToCache, readExpired, initialLevel, 1, null, java.util.<String>ArrayList());
  }
  public OSMLayer(TimeInterval timeToCache, boolean readExpired)
  {
     this(timeToCache, readExpired, 2, 1, null, java.util.<String>ArrayList());
  }
  public OSMLayer(TimeInterval timeToCache)
  {
     this(timeToCache, true, 2, 1, null, java.util.<String>ArrayList());
  }
  public OSMLayer(TimeInterval timeToCache, boolean readExpired, int initialLevel, float transparency, LayerCondition condition, java.util.ArrayList<String> layerInfo) // isTransparent
  {
