...
public class GenericQuadTree_Node {
   ...
   public final void symbolize(final GEOTileRasterizer geoTileRasterizer) {

      if (_elements.size() > 0) {
         final java.util.ArrayList<Geodetic2D> line = new java.util.ArrayList<Geodetic2D>();
         ...
         final GEOLineRasterSymbol symbol = new GEOLineRasterSymbol(line, ls);
