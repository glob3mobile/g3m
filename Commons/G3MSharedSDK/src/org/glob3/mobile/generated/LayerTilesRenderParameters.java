...
public class LayerTilesRenderParameters
{
  ...
  public final Sector _topSector = new Sector();
...
//#warning should _tileTextureResolution also be short?
  ...
  public final Vector2S _tileMeshResolution = new Vector2S();
//#endif
//C++ TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
//#if JAVA_CODE
  public final Vector2I _tileTextureResolution = new public();
  public final Vector2S _tileMeshResolution = new public();
//#endif
  ...
  public LayerTilesRenderParameters(Sector topSector, int topSectorSplitsByLatitude, int topSectorSplitsByLongitude, int firstLevel, int maxLevel, Vector2I tileTextureResolution, Vector2S tileMeshResolution, boolean mercator)
  {
	  ...
	  _tileMeshResolution = new Vector2S(tileMeshResolution);
	  _mercator = mercator;
...
//ORIGINAL LINE: const Vector2I splitsParameters = calculateTopSectorSplitsParametersWGS84(topSector);
	final Vector2I splitsParameters = calculateTopSectorSplitsParametersWGS84(new Sector(topSector));
...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: return new LayerTilesRenderParameters(topSector, topSectorSplitsByLatitude, topSectorSplitsByLongitude, firstLevel, maxLevel, LayerTilesRenderParameters::defaultTileTextureResolution(), LayerTilesRenderParameters::defaultTileMeshResolution(), mercator);
	return new LayerTilesRenderParameters(new Sector(topSector), topSectorSplitsByLatitude, topSectorSplitsByLongitude, firstLevel, maxLevel, LayerTilesRenderParameters.defaultTileTextureResolution(), LayerTilesRenderParameters.defaultTileMeshResolution(), mercator);
  }
...
//ORIGINAL LINE: static const java.util.ArrayList<const LayerTilesRenderParameters*> createDefaultMultiProjection(const int mercatorFirstLevel = 2, const int mercatorMaxLevel = 18, const int wgs84firstLevel = 0, const int wgs84maxLevel = 18)
...
//ORIGINAL LINE: boolean isEquals(const LayerTilesRenderParameters* that) const
...
//C++ TO JAVA CONVERTER WARNING: 'const' methods are not available in Java:
//ORIGINAL LINE: LayerTilesRenderParameters* copy() const
  public final LayerTilesRenderParameters copy()
  {
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: return new LayerTilesRenderParameters(_topSector, _topSectorSplitsByLatitude, _topSectorSplitsByLongitude, _firstLevel, _maxLevel, _tileTextureResolution, _tileMeshResolution, _mercator);
	return new LayerTilesRenderParameters(new Sector(_topSector), _topSectorSplitsByLatitude, _topSectorSplitsByLongitude, _firstLevel, _maxLevel, new Vector2I(_tileTextureResolution), new Vector2S(_tileMeshResolution), _mercator);
  }
