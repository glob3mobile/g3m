...
public class LayerTilesRenderParameters {
    ...
    */
   private static Vector2I calculateTopSectorSplitsParametersWGS84(final Sector topSector) {
   ...
   public LayerTilesRenderParameters(final Sector topSector,
                                     final int topSectorSplitsByLatitude,
                                     final int topSectorSplitsByLongitude,
                                     final int firstLevel,
                                     final int maxLevel,
                                     final Vector2I tileTextureResolution,
                                     final Vector2S tileMeshResolution,
   ...
   public static LayerTilesRenderParameters createDefaultWGS84(final int firstLevel,
                                                               final int maxLevel) {
      return createDefaultWGS84(Sector.fullSphere(), firstLevel, maxLevel);
   }


   public static LayerTilesRenderParameters createDefaultWGS84(final Sector topSector,
                                                               final int firstLevel,
                                                               final int maxLevel) {
      ...
      return new LayerTilesRenderParameters(topSector, topSectorSplitsByLatitude, topSectorSplitsByLongitude, firstLevel,
               maxLevel, LayerTilesRenderParameters.defaultTileTextureResolution(),
               LayerTilesRenderParameters.defaultTileMeshResolution(), mercator);
   }
   ...
   public static LayerTilesRenderParameters createDefaultMercator(final int firstLevel,
                                                                  final int maxLevel) {
   ...
   public static java.util.ArrayList<LayerTilesRenderParameters> createDefaultMultiProjection(final int mercatorFirstLevel,
            final int mercatorMaxLevel,
            final int wgs84firstLevel) {
   ...
   public final boolean isEquals(final LayerTilesRenderParameters that) {
      if (that == null) {
         return false;
      }
   ...
   public final LayerTilesRenderParameters copy() {
      return new LayerTilesRenderParameters(_topSector, _topSectorSplitsByLatitude, _topSectorSplitsByLongitude, _firstLevel,
               _maxLevel, _tileTextureResolution, _tileMeshResolution, _mercator);
   }
