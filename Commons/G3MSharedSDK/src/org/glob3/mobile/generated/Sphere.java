...
public class Sphere extends Ellipsoid
{
  ...
  private final double _oneOverRadiiSquared;
  ...
  {
    return new Vector3D(_radii, _radii, _radii);
  }
  ...
  public final java.util.ArrayList<Double> intersectionsDistances(Vector3D origin, Vector3D direction)
  {
    ...
    final double c = origin._x * origin._x + origin._y * origin._y + origin._z * origin._z - _radiiSquared;
