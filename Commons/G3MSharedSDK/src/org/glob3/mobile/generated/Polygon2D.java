...
public class Polygon2D {
   ...
   private final boolean                 _verticesCCW;
   ...
   private static boolean isEdgeInside(final int i,
                                       final int j,
                                       final java.util.ArrayList<Vector2D> remainingCorners,
   ...
   public Polygon2D(final java.util.ArrayList<Vector2D> coor) {
   ...
   public final short addTrianglesIndexesByEarClipping(final ShortBufferBuilder indexes,
      ...
      final java.util.ArrayList<Vector2D> remainingCorners = new java.util.ArrayList<Vector2D>();
      final java.util.ArrayList<Short> remainingIndexes = new java.util.ArrayList<Short>();
