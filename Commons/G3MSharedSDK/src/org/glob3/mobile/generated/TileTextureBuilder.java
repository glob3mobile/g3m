...
public class TileTextureBuilder extends RCObject
{
  ...
  public final RectangleF getImageRectangleInTexture(Sector wholeSector, Sector imageSector)
  {
    ...
    return new RectangleF((float) mu.round(lowerFactor._x * textureWidth), (float) mu.round(lowerFactor._y * textureHeight), (float) mu.round(widthFactor * textureWidth), (float) mu.round(heightFactor * textureHeight));
  }
