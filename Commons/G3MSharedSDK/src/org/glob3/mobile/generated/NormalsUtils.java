...
//ORIGINAL LINE: const Vector3F p10 = vertex1.sub(vertex0);
	final Vector3F p10 = vertex1.sub(new Vector3F(vertex0));
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: const Vector3F p20 = vertex2.sub(vertex0);
	final Vector3F p20 = vertex2.sub(new Vector3F(vertex0));
  
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: return p10.cross(p20);
	return p10.cross(new Vector3F(p20));
  }
...
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: addNormal(normals, index0, normal);
	  addNormal(normals, index0, new Vector3F(normal));
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: addNormal(normals, index1, normal);
	  addNormal(normals, index1, new Vector3F(normal));
//C++ TO JAVA CONVERTER WARNING: The following line was determined to be a copy constructor call - this should be verified and a copy constructor should be created if it does not yet exist:
//ORIGINAL LINE: addNormal(normals, index2, normal);
	  addNormal(normals, index2, new Vector3F(normal));
	}
