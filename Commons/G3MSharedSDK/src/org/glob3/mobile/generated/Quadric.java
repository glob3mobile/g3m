...
//ORIGINAL LINE: Quadric transformBy(const MutableMatrix44D& M) const
...
//ORIGINAL LINE: return Quadric(T.multiply(Q).multiply(I));
	return new Quadric(T.multiply(new MutableMatrix44D(Q)).multiply(new MutableMatrix44D(I)));
  }
