...
public class EllipsoidalTileTessellator
{
   public void dispose()
   {
   ...
   public Vector2I getTileMeshResolution(Planet planet, Vector2I rawResolution, Tile tile, boolean debug)
   {
     return calculateResolution(rawResolution, tile.getSector());
   }
   public Vector2I calculateResolution(Vector2I rawResolution, Sector sector)
   {
   ...
   public IShortBuffer createTileIndices(Planet planet, Sector sector, Vector2I tileResolution)
   {
   ...
   public IShortBuffer getTileIndices(Planet planet, Sector sector, Vector2I tileResolution)
   {
   ...
   public Mesh createTileMesh(Planet planet, Vector2I rawResolution, Tile tile, ElevationData elevationData, float verticalExaggeration, boolean mercator, boolean renderDebug)
   {
   ...
   public Vector2D getTextCoord(Tile tile, Angle latitude, Angle longitude, boolean mercator)
   {
     final Sector sector = tile.getSector();
   ...
   public IFloatBuffer createTextCoords(Vector2I rawResolution, Tile tile, boolean mercator)
   {
   ...
   public Mesh createTileDebugMesh(Planet planet, Vector2I rawResolution, Tile tile)
   {
     final Sector sector = tile.getSector();
