...
public class MainActivity extends Activity {
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		// FloatBufferBuilderFromGeodetic::builderWithoutCenter(context->getPlanet());
		//
		// _urls = [_iosWidget widget]->getPlanetRenderer()->getTilesURL(lower,
		// upper, 15);
		//
		// vertices->add(Geodetic2D::linearInterpolation(fromPosition,
		// toPosition, alpha),
		// height);
		// }
		//
		...
		// };
		//
		// PrecacherInitializationTask* initializationTask = new
		// PrecacherInitializationTask([self G3MWidget]);
