	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		if (true) {
			...
			final GTask elevationTask = new GTask() {
	            ...
	            ElevationDataProvider _elevationDataProvider1 = new SingleBillElevationDataProvider(new URL("file:///full-earth-2048x1024.bil", false),
                        Sector.fullSphere(),
                        new Vector2I(2048, 1024));

				@Override
				public void run(final G3MContext context) {
					PlanetRenderer pr = _g3mWidget.getG3MWidget().getPlanetRenderer();
		            ...
		            switch (i) {
		              ...
		              case 1:
		            	  ...
		            	  ElevationDataProvider _elevationDataProvider2 = new SingleBillElevationDataProvider(new URL("file:///caceres-2008x2032.bil", false),
		                                                                              Sector.fromDegrees(
		                                                                                                  39.4642996294239623,
		                                                                                                  -6.3829977122432933,
		                                                                                                  39.4829891936013553,
		                ...
		                break;
		              case 2:
		            	  pr.setVerticalExaggeration((float)(r.nextInt() % 5));
		                break;
		              case 3:
		            ...
		            ElevationDataProvider edp = pr.getElevationDataProvider();
		            if (edp != null){
			...
			builder.addPeriodicalTask(new PeriodicalTask(TimeInterval
					.fromSeconds(time), elevationTask));
