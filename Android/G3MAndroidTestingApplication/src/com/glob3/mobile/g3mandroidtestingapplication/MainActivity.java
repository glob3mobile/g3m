...
public class MainActivity
   ...
   protected void onCreate(final Bundle savedInstanceState) {
      ...
      if (false) { // Testing lights
         sr.addShape(new BoxShape(Geodetic3D.fromDegrees(0, 0, 0), AltitudeMode.RELATIVE_TO_GROUND, new Vector3D(1000000,
                  1000000, 1000000), (float) 1.0, Color.red(), Color.black(), true)); // With normals

         sr.addShape(new BoxShape(Geodetic3D.fromDegrees(0, 180, 0), AltitudeMode.RELATIVE_TO_GROUND, new Vector3D(1000000,
