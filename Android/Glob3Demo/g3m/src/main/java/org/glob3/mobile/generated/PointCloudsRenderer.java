...
//  class PointCloudLeafNode;
  ...
  private static class PointCloudMetadataParserAsyncTask extends GAsyncTask
  {
    ...
    private PointCloudLeafNode parseLeafNode(ByteBufferIterator it)
    {
  ...
  private static class PointCloud
  {
    ...
    public final void initialize(G3MContext context)
    {
      ...
      context.getDownloader().requestBuffer(metadataURL, _downloadPriority, _timeToCache, _readExpired, new PointCloudMetadataDownloadListener(this, context.getThreadUtils()), true);
    }
