...
//    MBLayer(MBLayer that);
    ...
    public static MBLayer fromJSON(JSONBaseObject jsonBaseObject, boolean verbose)
    {
      ...
      return new MBLayer(type, url, verbose); // attribution,
    }
...
//  class MBHandler;
  ...
  public abstract static class MBSymbology extends RCObject
  {
    ...
    public static MBSymbology fromJSON(MBHandler handler, String datasetID, String datasetName, JSONBaseObject jsonBaseObject)
    {
      if (jsonBaseObject == null)
      {
        return null;
...
//    MBShape(MBShape that);
  ...
  public static class MBVectorSymbology extends MBSymbology
  {
    ...
    public static MBVectorSymbology fromJSON(MBHandler handler, String datasetID, String datasetName, JSONObject jsonObject)
    {
  ...
  public static class MBSymbolizedDataset
  {
    ...
    public static MBSymbolizedDataset fromJSON(MBHandler handler, JSONBaseObject jsonBaseObject, boolean verbose)
    {
      if (jsonBaseObject == null)
      {
        return null;
  ...
  public static class MBMap
  {
    ...
    private java.util.ArrayList<MBLayer> _layers = new java.util.ArrayList<MBLayer>();
    private java.util.ArrayList<MBSymbolizedDataset> _symbolizedDatasets = new java.util.ArrayList<MBSymbolizedDataset>();
...
//    MBMap(MBMap that);
    ...
    private MBMap(String id, String name, java.util.ArrayList<MBLayer> layers, java.util.ArrayList<MBSymbolizedDataset> symbolizedDatasets, boolean verbose)
          // int                                        timestamp,
    ...
    private static java.util.ArrayList<MBLayer> parseLayers(JSONArray jsonArray, boolean verbose)
    {
      java.util.ArrayList<MBLayer> result = new java.util.ArrayList<MBLayer>();
    ...
    private static java.util.ArrayList<MBSymbolizedDataset> parseSymbolizedDatasets(MBHandler handler, JSONArray jsonArray, boolean verbose)
    {
      java.util.ArrayList<MBSymbolizedDataset> result = new java.util.ArrayList<MBSymbolizedDataset>();
      for (int i = 0; i < jsonArray.size(); i++)
      {
    ...
    public static MBMap fromJSON(MBHandler handler, JSONBaseObject jsonBaseObject, boolean verbose)
    {
      if (jsonBaseObject == null)
      {
        return null;
      ...
      java.util.ArrayList<MBLayer> layers = parseLayers(jsonObject.get("layerSet").asArray(), verbose);
      java.util.ArrayList<MBSymbolizedDataset> symDatasets = parseSymbolizedDatasets(handler, jsonObject.get("symbolizedDatasets").asArray(), verbose);
  ...
  public interface MBMapsHandler
  {
    ...
    void onMaps(java.util.ArrayList<MBMap> maps);
  ...
  private void applyMap(MBMap map, VectorStreamingRenderer.VectorSetSymbolizer symbolizer, boolean deleteSymbolizer)
  {
    if (_verbose)
    {
...
//  MapBoo(MapBoo that);
  ...
  public final void setMap(MBMap map)
  {
  ...
  public final void onMap(MBMap map, VectorStreamingRenderer.VectorSetSymbolizer symbolizer, boolean deleteSymbolizer)
  {
