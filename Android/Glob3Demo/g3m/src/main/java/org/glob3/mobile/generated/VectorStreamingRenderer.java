...
//  class Node;
  ...
  public static class GEOJSONUtils
  {
    ...
    public static Node parseNode(JSONObject json, VectorSet vectorSet, boolean verbose)
    {
  ...
  public static class FeaturesParserAsyncTask extends GAsyncTask
  {
    ...
    private java.util.ArrayList<Cluster> parseClusters(JSONArray jsonArray)
    {
      ...
      java.util.ArrayList<Cluster> clusters = new java.util.ArrayList<Cluster>();
    ...
    private java.util.ArrayList<Node> parseChildren(JSONArray jsonArray)
    {
      if ((jsonArray == null) || (jsonArray.size() == 0))
      {
        return null;
  ...
  public static class Node extends RCObject
  {
    ...
    private boolean isVisible(G3MRenderContext rc, VectorSet vectorSet, Frustum frustumInModelCoordinates)
    {
    ...
    private boolean isBigEnough(G3MRenderContext rc, VectorSet vectorSet)
    {
      if ((_nodeSector._deltaLatitude._degrees >= vectorSet._minSectorSize._degrees) || (_nodeSector._deltaLongitude._degrees >= vectorSet._minSectorSize._degrees))
      {
        return true;
    ...
    public final long render(G3MRenderContext rc, VectorSet vectorSet, Frustum frustumInModelCoordinates, GLState glState)
    {
  ...
  {
    public static MagnitudeMetadata fromJSON(JSONObject jsonObject)
    {
      if (jsonObject == null)
      {
        return null;
  ...
  public abstract static class VectorSetSymbolizer
  {
    ...
    public abstract Mark createGeometryMark(Metadata metadata, Node node, GEO2DPointGeometry geometry);

    public abstract Mark createGeometryMark(Metadata metadata, Node node, GEO3DPointGeometry geometry);

    public abstract Mark createClusterMark(Metadata metadata, Node node, Cluster cluster);
  }
