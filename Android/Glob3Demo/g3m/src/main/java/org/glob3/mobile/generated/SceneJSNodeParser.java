...
public class SceneJSNodeParser
{
  ...
  private static SGNode toNode(JSONBaseObject jsonBaseObject, Statistics statistics, SceneJSParserParameters parameters)
  {
    SGNode result = null;
  ...
  private static SGNode createNode(JSONObject jsonObject, Statistics statistics, SceneJSParserParameters parameters)
  {
  ...
  private static SGRotateNode createRotateNode(JSONObject jsonObject, Statistics statistics, SceneJSParserParameters parameters)
  {
    final String id = jsonObject.getAsString("id", "");
    final String sID = jsonObject.getAsString("sid", "");
  ...
  private static SGTranslateNode createTranslateNode(JSONObject jsonObject, Statistics statistics, SceneJSParserParameters parameters)
  {
    final String id = jsonObject.getAsString("id", "");
    final String sID = jsonObject.getAsString("sid", "");
  ...
  private static SGMaterialNode createMaterialNode(JSONObject jsonObject, Statistics statistics, SceneJSParserParameters parameters)
  {
    final String id = jsonObject.getAsString("id", "");
    final String sID = jsonObject.getAsString("sid", "");
  ...
  private static SGTextureNode createTextureNode(JSONObject jsonObject, Statistics statistics, SceneJSParserParameters parameters)
  {
    final String id = jsonObject.getAsString("id", "");
    final String sID = jsonObject.getAsString("sid", "");
  ...
  private static SGGeometryNode createGeometryNode(JSONObject jsonObject, Statistics statistics, SceneJSParserParameters parameters)
  {
    final String id = jsonObject.getAsString("id", "");
    final String sID = jsonObject.getAsString("sid", "");
  ...
  private static SGLayerNode createLayerNode(JSONObject jsonObject, Statistics statistics, SceneJSParserParameters parameters)
  {
    final String id = jsonObject.getAsString("id", "");
    final String sID = jsonObject.getAsString("sid", "");
  ...
  private static void parseChildren(JSONObject jsonObject, SGNode node, Statistics statistics, SceneJSParserParameters parameters)
  {
