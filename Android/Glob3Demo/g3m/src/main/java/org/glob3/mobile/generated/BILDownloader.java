...
public class BILDownloader
{
  ...
  public static void request(G3MContext context, URL url, long priority, TimeInterval timeToCache, boolean readExpired, Sector sector, Vector2I extent, double deltaHeight, short noDataValue, Handler handler, boolean deleteHandler)
  {


    context.getDownloader().requestBuffer(url, priority, timeToCache, readExpired, new BufferDownloadListener(sector, extent, noDataValue, deltaHeight,handler, deleteHandler, context), true);
  }
  ...
  public static class ParserAsyncTask extends GAsyncTask
  {
    ...
    public ParserAsyncTask(IByteBuffer buffer, Sector sector, Vector2I extent, short noDataValue, double deltaHeight, Handler handler, boolean deleteHandler)
    {
       _buffer = buffer;
  ...
  public static class BufferDownloadListener extends IBufferDownloadListener
  {
    ...
    public BufferDownloadListener(Sector sector, Vector2I extent, short noDataValue, double deltaHeight, Handler handler, boolean deleteHandler, G3MContext context)
    {
       _sector = new Sector(sector);
       _extent = extent;
       _noDataValue = noDataValue;
    ...
    {
      GAsyncTask parserTask = new ParserAsyncTask(buffer, _sector, _extent, _noDataValue, _deltaHeight, _handler, _deleteHandler);
