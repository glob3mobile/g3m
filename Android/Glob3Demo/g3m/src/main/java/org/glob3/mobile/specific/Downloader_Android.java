...
public final class Downloader_Android
   ...
   public boolean cancelRequest(final long requestID) {
      ...
      synchronized (this) {
         ...
         Iterator<Entry<String, Downloader_Android_Handler>> iter = _queuedHandlers.entrySet().iterator();

         while (iter.hasNext() && !found) {
            final Entry<String, Downloader_Android_Handler> e = iter.next();
   ...
   public void cancelRequestsTagged(final String tag) {
      ...
      synchronized (this) {
         ...
         for (final Iterator<Entry<String, Downloader_Android_Handler>> iterator = _queuedHandlers.entrySet().iterator(); iterator.hasNext();) {
            final Entry<String, Downloader_Android_Handler> entry = iterator.next();
   ...
   Downloader_Android_Handler getHandlerToRun() {
      ...
      synchronized (this) {
         ...
         for (final Entry<String, Downloader_Android_Handler> e : _queuedHandlers.entrySet()) {
