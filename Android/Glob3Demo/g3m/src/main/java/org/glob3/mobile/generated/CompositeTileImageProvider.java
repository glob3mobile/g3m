...
public class CompositeTileImageProvider extends CanvasTileImageProvider
{
  ...
  private static class ChildResult
  {
    ...
    public static ChildResult image(IImage image, String imageID, TileImageContribution contribution)
    {
      return new ChildResult(false, false, image, imageID, contribution, ""); // error -  isCanceled -  isError
    }

    public static ChildResult error(String error)
    {
      return new ChildResult(true, false, null, "", null, error); // contribution -  imageID -  image -  isCanceled -  isError
    }

    public static ChildResult cancelation()
    {
      return new ChildResult(false, true, null, "", null, ""); // error -  contribution -  imageID -  image -  isCanceled -  isError
    }
