  ...
  public static ArrayList<Poi> getPOIs(final String json,
    ...
    for (int i = 0; i < features.size(); i++) {
      ...
      if (WIKILOCATION.equals(service)) {
        final JSONArray coordinates = features.getAsObject(i).getAsObject(
            "geometry").getAsArray("coordinates");
        final JSONObject properties = features.getAsObject(i).getAsObject(
            "properties");
