...
//#undef M
	...
	*/
	...
	public static Vector3D gluUnProject(double winx, double winy, double winz, double[] model, double[] proj, int[] viewport)
	{
		/* matrice de transformation */
		...
		/* calcul transformation inverse */
		GlobalMembersGLU.matmul(A, proj, model);
		invert_matrix(A, m);
	...
	public static Vector3D gluProject(double objx, double objy, double objz, double[] model, double[] proj, int[] viewport)
	{
		// matrice de transformation
		double[] in = new double[4];
		double[] out = new double[4];
...
*/
	...
	public static void ComputeTranslationMatrix(Vector3D t, double[] M)
	{
	...
	public static void ComputeRotationMatrix(double angle_rad, Vector3D p, double[] M)
	{
	...
	public static void ComputeLookAtMatrix(Vector3D pos, Vector3D center, Vector3D up, double[] M)
	{
	...
	public static void ComputeProjectionMatrix(double left, double right, double bottom, double top, double near, double far, float[] projection)
	{
