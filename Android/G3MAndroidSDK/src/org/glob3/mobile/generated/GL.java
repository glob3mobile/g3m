...
public class GL {
   ...
   private final java.util.LinkedList<MutableMatrix44D> _matrixStack   = new java.util.LinkedList<MutableMatrix44D>();
   ...
   private void loadModelView() {
      final float[] M = _modelView.getColumnMajorFloatArray();
   ...
   private int checkedGetAttribLocation(final int program,
                                        final String name) {
      final int l = _gl.getAttribLocation(program, name);
      if (l == -1) {
   ...
   private int checkedGetUniformLocation(final int program,
                                         final String name) {
      final int l = _gl.getUniformLocation(program, name);
      if (l == -1) {
   ...
   public final void enableVertexFlatColor(final float r,
                                           final float g,
                                           final float b,
                                           final float a,
   ...
   public final void clearScreen(final float r,
                                 final float g,
                                 final float b,
                                 final float a) {
      _gl.clearColor(r, g, b, a);
      final GLBufferType[] buffers = { GLBufferType.ColorBuffer, GLBufferType.DepthBuffer };
      _gl.clear(2, buffers);
   }


   public final void color(final float r,
                           final float g,
                           final float b,
                           final float a) {
   ...
   public final void enableVertexColor(final IFloatBuffer colors,
                                       final float intensity) {
   ...
   public final void loadMatrixf(final MutableMatrix44D modelView) {
   ...
   public final void multMatrixf(final MutableMatrix44D m) {
   ...
   public final void vertexPointer(final int size,
                                   final int stride,
                                   final IFloatBuffer vertices) {
   ...
   public final void drawTriangleStrip(final IIntBuffer indices) {
      _gl.drawElements(GLPrimitive.TriangleStrip, indices.size(), indices);
   }


   public final void drawLines(final IIntBuffer indices) {
      _gl.drawElements(GLPrimitive.Lines, indices.size(), indices);
   }


   public final void drawLineLoop(final IIntBuffer indices) {
      _gl.drawElements(GLPrimitive.LineLoop, indices.size(), indices);
   }


   public final void drawPoints(final IIntBuffer indices) {
      _gl.drawElements(GLPrimitive.Points, indices.size(), indices);
   }


   public final void setProjection(final MutableMatrix44D projection) {
      final float[] M = projection.getColumnMajorFloatArray();
      _gl.uniformMatrix4fv(GlobalMembersGL.Uniforms.Projection, 1, false, M);
   }


   public final boolean useProgram(final int program) {
      // set shaders
   ...
   public final void enablePolygonOffset(final float factor,
                                         final float units) {
   ...
   public final void pointSize(final float size) {
   ...
   public final GLTextureId uploadTexture(final IImage image,
   ...
   public final void setTextureCoordinates(final int size,
                                           final int stride,
                                           final IFloatBuffer texcoord) {
   ...
   public final void bindTexture(final GLTextureId textureId) {
   ...
   public final void drawBillBoard(final GLTextureId textureId,
                                   final IFloatBuffer vertices,
                                   final float viewPortRatio) {
      final int TODO_refactor_billboard;
   ...
   public final void deleteTexture(final GLTextureId textureId) {
      if (!textureId.isValid()) {
         return;
      }
      final int[] textures = { textureId.getGLTextureId() };
   ...
   public final void enableCullFace(final GLCullFace face) {
      if (!_enableCullFace) {
   ...
   public final void transformTexCoords(final float scaleX,
                                        final float scaleY,
   ...
   public final void transformTexCoords(final double scaleX,
                                        final double scaleY,
   ...
   public final void transformTexCoords(final Vector2D scale,
                                        final Vector2D translation) {
      transformTexCoords((float) scale.x(), (float) scale.y(), (float) translation.x(), (float) translation.y());
   }


   public final void transformTexCoords(final MutableVector2D scale,
                                        final MutableVector2D translation) {
      transformTexCoords((float) scale.x(), (float) scale.y(), (float) translation.x(), (float) translation.y());
   }


   public final void color(final Color col) {
      color(col.getRed(), col.getGreen(), col.getBlue(), col.getAlpha());
   }


   public final void clearScreen(final Color col) {
      clearScreen(col.getRed(), col.getGreen(), col.getBlue(), col.getAlpha());
   }


   public final void enableVertexFlatColor(final Color c,
                                           final float intensity) {
   ...
   public final void getViewport(final int[] v) {
