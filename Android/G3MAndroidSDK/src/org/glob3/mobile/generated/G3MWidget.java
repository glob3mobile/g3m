...
public class G3MWidget {
   ...
   public static G3MWidget create(final FrameTasksExecutor frameTasksExecutor,
      ...
      return new G3MWidget(frameTasksExecutor, gl, texturesHandler, textureBuilder, downloader, planet, cameraConstrainers,
               renderer, busyRenderer, effectsScheduler, width, height, backgroundColor, logFPS, logDownloaderStatistics,
               initializationTask, autoDeleteInitializationTask, periodicalTasks);
   }
   ...
   public final void render() {
      ...
      final RenderContext rc = new RenderContext(_frameTasksExecutor, IFactory.instance(), IStringUtils.instance(),
               ...
               _currentCamera, _nextCamera, _texturesHandler, _textureBuilder, _downloader, _effectsScheduler,
      ...
      final Renderer selectedRenderer = _rendererReady ? _renderer : _busyRenderer;
   ...
   public final void onPause() {
      final InitializationContext ic = new InitializationContext(IFactory.instance(), IStringUtils.instance(),
               IThreadUtils.instance(), ILogger.instance(), IMathUtils.instance(), IJSONParser.instance(), _planet, _downloader,
               _effectsScheduler);
