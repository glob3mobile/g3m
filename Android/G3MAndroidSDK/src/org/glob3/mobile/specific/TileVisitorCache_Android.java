...
public class TileVisitorCache_Android implements ITileVisitor {
   ...
   @Override
   public final void visitTile(final ArrayList<Layer> layers, final Tile tile) {
      ...
      for (final Layer layer : layers) {
         for (final URL url : layer.getDownloadURLs(tile)) {
            ...
            _context.getDownloader().requestImage(url, 1, timeToCache, true, new IImageDownloadListenerTileCache(_debugCounter, _listener), true);
            _debugCounter++;
