...
public class GL2 extends IGL {
   ...
   private FloatBuffer floatArrayToFloatBuffer(final float[] fv) {
      ...
      if (!arrayToBufferMap.containsKey(fv)) {
         ...
         fb.put(fv); ///TOO SLOW UNTIL VERSION GINGERBEAD (BECAUSE OF THIS, USE HASHMAP)
	...
	public void drawTriangleStrip(int n, byte[] i) {
	    ...
	    GLES20.glDrawElements(GLES20.GL_TRIANGLE_STRIP, n, GLES20.GL_UNSIGNED_BYTE, indexBuffer);
	}
	...
	public void drawLines(int n, byte[] i) {
	    final ByteBuffer indexBuffer = ByteBuffer.wrap(i);
	    GLES20.glDrawElements(GLES20.GL_LINES, n, GLES20.GL_UNSIGNED_BYTE, indexBuffer);
	}
	...
	public void drawLineLoop(int n, byte[] i) {
	    final ByteBuffer indexBuffer = ByteBuffer.wrap(i);
	    GLES20.glDrawElements(GLES20.GL_LINE_LOOP, n, GLES20.GL_UNSIGNED_BYTE, indexBuffer);
	}
	...
	public void useProgram(int program) {
	    ...
	    Attributes.TextureCoord = GLES20.glGetAttribLocation(program, "TextureCoord");
	
	    // Extract the handles to uniforms
	    Uniforms.Projection = GLES20.glGetUniformLocation(program, "Projection");
	    ...
	    Uniforms.EnableTexture = GLES20.glGetUniformLocation(program, "EnableTexture");
	    ...
	    Uniforms.ViewPortRatio = GLES20.glGetUniformLocation(program, "ViewPortRatio");
	}
